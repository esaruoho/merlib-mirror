...
source_path: locations/styled-8/styled-34/page80.html
order: 91
...
*Source page: `locations/styled-8/styled-34/page80.html`*
...
simply learning a natural approach to solutions in hypnosis
...
simple
Hypnosis has been understood as complex, special, even dangerous, requiring unique legal restrictions. It has been associated with magic, the devil, loss of control, and only relevant to susceptible individuals. 
In this programme we will explore simple, elegant and respectful ways of connecting clients with their own unique styles of experience.
learning
...
a natural approach
Hypnosis has been assumed to be a special, different, even weird experience. Erickson spoke of the everyday trance as a natural experience that can be enhanced in a clinical situation. By utilising individual clients’ individual skills, overlooked skills can be disclosed, re-connected, and found to be readily available, leading to a fail-safe method will be made obvious and readily useable.
solutions
...
hypnosis
Traditional hypnosis relies on manualised scripts which are applied to clients in a "fit where it touches" approach, creating resistance and limited compliance. When we begin with the principle that hypnosis is an experience that involves focus of attention and absorption in that experience, this natural ability can be readily accessed by all clients and incorporated in any clinician’s practice.
What you will learn
	•	The evolution of hypnosis throughout history and a contemporary understanding.
	•	A fail-safe method of assisting any client to experience hypnosis.
	•	Observational skills to track an individual client's hypnotic experience.
	•	Ways to create rapport and restore trust.
	•	Creating possibilities even in the most "resistant" or "chronic" situations.
	•	The creation of learning as a process towards solutions.
	•	The use of therapeutic metaphor.
	•	Become familiar with the classical hypnotic experiences of dissociation, age regression, etc.
...
Course Structure
The diploma involves 12 workshop days over 6 months and includes recorded lectures, demonstrations and a written text and any programme can be repeated free of charge at any time in the future. The emphasis is on live demonstrations and the opportunity for you to practice recurrently in pairs or triads. This diploma values experiential learning over acquisition of information so that you will feel confident to incorporate these ideas into your work immediately.
Accreditation
These programmes are accredited by CET, as evidence shows overwhelmingly that external accreditation has no correlation with effectiveness of learning or application. And ASCH recognise this diploma as contributing to membership of ASCH which is a member organisation of ACA. This connectn aloows for the possibility of insurance etc. AHA also recognise this diploma.
Summary
This diploma provides learning opportunities which are individualised, practical, relevant, easily understood, readily translatable into clinical practice, all in a safe environment of respectful support.
Cost
Full payment by beginning of programme $1925

Or payment for the  2 day intensive then 4 monthly payments of $385 each month from 1st June - 1 September, 2014
Payment
...
full payment $1,925.00 AUD
	
intensive early bird $325.00 AUD
	
intensive after 16.02.14 $385.00 AUD
	
June payment $385.00 AUD
	
July payment $385.00 AUD
	
August payment $385.00 AUD
	
September $385.00 AUD
...
Dates: 
May 17&18, July 12&13, September 20&21, November 15&16
Neil Mellor will organise 4 Saturdays for additional conversations and practice - dates to be decided
Times: 9.00 - 5.00
Registration
 [essential]:
Programme - diploma
