---
title: "open learning hypnosis 3"
source_domain: cet.net.au
source_path: locations/page40/page48/page48.html
order: 72
...
# open learning hypnosis 3

*Source page: `locations/page40/page48/page48.html`*
...
In this third module, we will focus on and refine the application of the principles from the first two modules to specific clinical situations including problems of mood, pain, relationships.
In this programme we will refine how we can apply these principles to:
anxiety
depression
panic disorder
phobias
healing trauma
pain management
habit control - cigarette, weight, sleep, etc.
relationship issues including sexual problems
...
8 evaluation and consolidation of the learning
...
Further learning.
This programme functions as the third of 3 modules of the 
