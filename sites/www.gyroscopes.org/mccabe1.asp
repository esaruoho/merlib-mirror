...
<head>
  ...
  <META NAME="Description" CONTENT="Gyroscopes have many uses, this site explains how a gyroscope works and what it can be used for. The site also looks at the possible use of gyroscope based propulsion (gyroscopic propulsion). ">
...
<TABLE WIDTH="684" BORDER=0 CELLPADDING=7 cellspacing=0>
  <TR>
    <TD WIDTH="684">
      <H1>HTTP Error 404 - The page cannot be found</H1>
      <BR>
      ...
      another link. 
      <LI>Visit our home <A href="/">Page</A> .</LI></UL>
    </TD>
  </TR>
</TABLE>
    </td>
  ...
  Website. Copyright &copy; 2004 Glenn Turner. All rights reserved. <a href="/site.asp">site info</a><br>
