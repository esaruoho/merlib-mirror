...
<table align="center" width="100%" border="0">
  ...
  <tr>
    <td align="center" colspan="3">
      ...
      <p>
      To buy a gyroscope visit <a href="http://www.gyroscope.com/">www.gyroscope.com</a><br>
...
<!--
  function validForm(){
    if(document.question["name"].value == "" ||
       document.question["email"].value == "" ||
       document.question["subject"].value == "" ||
...
<h3 align="center">Fill in the form to ask a question on the site.</h3>
  <form onsubmit="return validForm()" action="/forum/askquestion.asp" method=post name="question">

<table align="center" border="0">
  <tr>
    <td align="right" valign="middle"><b>Name:</b></td>
    <td align="left" valign="middle"><input type=text name="name" value="" class=text size=20 style="width:200px"></td>
    <td align="left" valign="middle" nowrap>Your full name i.e. John Smith</td>
  </tr>
  <tr>
    <td align="right" valign="middle"><b>Email:</b></td>
    <td align="left" valign="middle"><input type=text name="email" value="" class=text size=20 style="width:200px"></td>
    <td align="left" valign="middle" nowrap>Your email address i.e. John@smith.net</td>
  </tr>
  <tr>
    <td align="right" valign="middle"><b>Subject:</b></td>
    <td align="left" valign="middle"><input type=text name="subject" value="" class=text size=20 style="width:200px"></td>
    <td align="left" valign="middle" nowrap>Question in brief i.e. How does a gyroscope work?</td>
  </tr>
  <tr>
    <td align="right" valign="top"></td>
    <td align="left" valign="top">&nbsp;</td>
    <td align="left" valign="bottom" nowrap>The entire question</td>
  </tr>
  <tr>
    <td align="right" valign="top"><b>Question:</b></td>
  ...
  <tr>
    <td align="center" colspan="3">
      <input type="submit" value="Ask Question&#062;&#062;" id=submit1 name=submit1>
    </td>
  </tr>
  </form>
</table>
