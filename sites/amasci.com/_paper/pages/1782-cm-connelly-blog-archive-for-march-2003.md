---
title: "C.M. Connelly: Blog: Archive for March, 2003"
source_domain: amasci.com
source_path: ~c/blog/archive/2003-03.html
order: 1782
...
# C.M. Connelly: Blog: Archive for March, 2003

*Source page: `~c/blog/archive/2003-03.html`*
...
<span id="entry:03-1"></span>[<img src="../../images/links.gif" class="permalink" data-border="0" width="21" height="29" alt="permanent link" />](2003-03.html#day:03-1)Our TV died today. I was in the other room, but apparently it was fine and then it started displaying a wide horizontal white band. No sound, either.
...
<span id="entry:06-1"></span>[<img src="../../images/links.gif" class="permalink" data-border="0" width="21" height="29" alt="permanent link" />](2003-03.html#day:06-1)We've been to a bunch of stores and done a ton of research online. There are damn few TVs worth having, from what I can tell, but strong in the running after our first night were a 32" Sony widescreen plasma TV (\$4500), a 27" and 24" Sony tube TV (\$400-600), a Samsung 30" widescreen (\$1000), and a couple of others.
...
<span id="entry:07-1"></span>[<img src="../../images/links.gif" class="permalink" data-border="0" width="21" height="29" alt="permanent link" />](2003-03.html#day:07-1)Dave Hyatt on [tabbed browsing](http://www.mozillazine.org/weblogs/hyatt/archives/2003_03.html#002603). Interesting stuff, especially his discussion of the different ways that tabs can be (and have been) implemented.
...
<span class="blogcred">Via [Slashdot](http://developers.slashdot.org/article.pl?sid=03/03/07/1451200&mode=nested&tid=189).</span>

</div>

<div class="entry">

<span id="entry:07-2"></span>[<img src="../../images/links.gif" class="permalink" data-border="0" width="21" height="29" alt="permanent link" />](2003-03.html#day:07-2)Expedia's site is confusing. When you're booking a flight, it presents you with a list of possible flights at different times and on different airlines, each with its own price. You choose one of those and go on to a page presenting similar information for your return flight, including the prices again. A naive user (\*waves\*) might be excused for believing that each leg of the flight has a separate charge, meaning that an estimate would be twice as high as the actual cost. (Going all the way through the selection process gives you the correct total, of course.)
...
<span id="entry:14-1"></span>[<img src="../../images/links.gif" class="permalink" data-border="0" width="21" height="29" alt="permanent link" />](2003-03.html#day:14-1)Off to Seattle. By 'plane, always an enjoyable experience in our post-9/11 world.
...
<span id="entry:15-1"></span>[<img src="../../images/links.gif" class="permalink" data-border="0" width="21" height="29" alt="permanent link" />](2003-03.html#day:15-1)Off to Portland for a hockey game between B & J's beloved [Seattle Thunderbirds](http://www.seattle-thunderbirds.com/) and their main rivals, Portland's [Winterhawks](http://www.winterhawks.com/). The teams had played in Seattle on Friday, and Seattle had won. Feelings were running high, and B & J's Seattle jerseys drew some attention from the home team's fans. Luckily, we were sitting near lots of other Thunderbirds fans, so no one tried to attack them (or us).
...
<span id="entry:17-1"></span>[<img src="../../images/links.gif" class="permalink" data-border="0" width="21" height="29" alt="permanent link" />](2003-03.html#day:17-1)We hit downtown Seattle. My main goal is checking out the bags at the new [Tom Bihn](http://www.tombihn.com/) store; everything else is gravy.

</div>

<div class="entry">

<span id="entry:17-2"></span>[<img src="../../images/links.gif" class="permalink" data-border="0" width="21" height="29" alt="permanent link" />](2003-03.html#day:17-2)I had been looking at the bags from Tom Bihn for a couple of years. Brian got himself a [Brain Bag](http://www.tombihn.com/Merchant2/merchant.mv?Screen=PROD&Store_Code=001&Product_Code=TB0104&Product_Count=3&Category_Code=TBP) to carry around his laptop and a bunch of other equipment. I was in the market for a briefcase format bag to replace my Novell briefcase, which was pretty awkward, most notably because it didn't have a compartment you could pop a book into without opening the main flap, and because without the flap closed with at least one of the two clips, picking it up caused it to hang badly.

Anyway, I had been looking at the [Empire Builder](http://www.tombihn.com/Merchant2/merchant.mv?Screen=PROD&Store_Code=001&Product_Code=TB0730&Product_Count=1&Category_Code=TBP). I had some worries, though, as the FAQ warned about it being kind of large for people my size. Then came the [ID](http://www.tombihn.com/Merchant2/merchant.mv?Screen=PROD&Store_Code=001&Product_Code=TB0805&Product_Count=1&Category_Code=TBP), which was smaller, and also came in some interesting colors.
...
<span id="entry:17-3"></span>[<img src="../../images/links.gif" class="permalink" data-border="0" width="21" height="29" alt="permanent link" />](2003-03.html#day:17-3)This day was one of the finest I've ever seen in my visits to Seattle—no rain! Sun! But still pleasantly cool. Definitely my favorite weather in months.
...
<span id="entry:17-4"></span>[<img src="../../images/links.gif" class="permalink" data-border="0" width="21" height="29" alt="permanent link" />](2003-03.html#day:17-4)We also spent a fair amount of time in [Pike Place Market](http://www.pikeplacemarket.org/). We ate lunch at the [Pike Pub](http://www.merchantduvin.com/pages/3_pike_brewing/pub_welcome.html), then wandered around the Market. We looked at reproduction and original posters in one shop, pen and ink drawings in another, and cloisonne jewelry in another.

</div>

<div class="entry">

<span id="entry:17-5"></span>[<img src="../../images/links.gif" class="permalink" data-border="0" width="21" height="29" alt="permanent link" />](2003-03.html#day:17-5)We also hit [<span class="abbr" title="Recreational Equipment, Inc.">REI</span>](http://www.rei.com/), a cooperative based in Seattle that sells equipment for camping, rock and mountain climbing, skiing, bicycling, kayaking, and so forth. I had joined years ago, but hadn't kept my address up to date with them. After some searching around, they actually found my records under my Canadian address.
...
<span id="entry:18-1"></span>[<img src="../../images/links.gif" class="permalink" data-border="0" width="21" height="29" alt="permanent link" />](2003-03.html#day:18-1)Off to the new [Washington State Historical Museum](http://www.wshs.org/wshm/) in Tacoma. The museum itself was okay—a bit heavy on the “white folks killed the Indians” guilt trip—but it had some interesting exhibits about the internment of Japanese Americans during World War II, and a surprising amount of material about Hanford's nuclear work.
...
<span id="entry:19-1"></span>[<img src="../../images/links.gif" class="permalink" data-border="0" width="21" height="29" alt="permanent link" />](2003-03.html#day:19-1)Back from Seattle!

We did the [Seattle Underground](http://www.undergroundtour.com/) tour, which was both fun and interesting. Having read about Seattle's crazy history, I never quite understood how things worked; the tour helped a lot.
...
<span id="entry:21-1"></span>[<img src="../../images/links.gif" class="permalink" data-border="0" width="21" height="29" alt="permanent link" />](2003-03.html#day:21-1)Saw one of the Goodyear blimps doing crazy maneuvers—diving and climbing and making sharp turns—over Cable Field. My guess is that they're training a new pilot. I'm jealous.
...
[newer entries](2003-04.html) \| [older entries](2003-02.html)
...
<thead>
<tr>
<th><a href="2003-02.html" title="Back to February, 2003">&lt;&lt;</a></th>
<th colspan="5">March, 2003</th>
<th><a href="2003-04.html" title="On to April, 2003">&gt;&gt;</a></th>
</tr>
</thead>
<tbody>
<tr>
...
<tr>
<td><a href="#day:03" title="Entry for 2003-03-03">3</a></td>
<td>4</td>
<td>5</td>
<td><a href="#day:06" title="Entry for 2003-03-06">6</a></td>
<td><a href="#day:07" title="Entry for 2003-03-07">7</a></td>
<td>8</td>
<td>9</td>
</tr>
<tr>
...
<td>12</td>
<td>13</td>
<td><a href="#day:14" title="Entry for 2003-03-14">14</a></td>
<td><a href="#day:15" title="Entry for 2003-03-15">15</a></td>
<td><a href="#day:16" title="Entry for 2003-03-16">16</a></td>
</tr>
<tr>
<td><a href="#day:17" title="Entry for 2003-03-17">17</a></td>
<td><a href="#day:18" title="Entry for 2003-03-18">18</a></td>
<td><a href="#day:19" title="Entry for 2003-03-19">19</a></td>
<td>20</td>
<td><a href="#day:21" title="Entry for 2003-03-21">21</a></td>
<td>22</td>
<td><a href="#day:23" title="Entry for 2003-03-23">23</a></td>
</tr>
<tr>
<td>24</td>
<td>25</td>
...
[<img src="../../images/Valid_XHTML10.png" data-border="0" width="88" height="31" alt="Valid XHTML 1.0!" />](http://validator.w3.org/check?uri=http://www.eskimo.com/~c/blog/archive/2003-03.html;ss)
...
Please [e-mail me about problems with this page](mailto:c@eskimo.com?Subject=Problem%20with%20/eskimo/blog/archive/2003-03.html). Thanks.
