...
source_path: ~vecna/g99_game01.html
order: 9417
...
*Source page: `~vecna/g99_game01.html`*
...
<tbody>
<tr>
<td><img src="g99_gurps.gif" width="350" height="247" /></td>
<td><h1 id="gaming-at-the-gathering">Gaming at the Gathering!</h1></td>
</tr>
</tbody>
</table>

    The [Gathering 99, Gargoyles World Tour in Dallas](http://www.khatt.net/gwt), will be the site for one of the\
first convention RPGs based on ***Gargoyles***. This game will be run by fanfic author\
and one of the con's writing guests, [Christine Morgan.](mailto:vecna@eskimo.com) To visit Christine's personal\
gaming page, click [here](gurps.html).
...
    The game will use the Generic Universal Role-Playing System, abbreviated [GURPS](http://www.sjgames.com/gurps/),\
by [Steve Jackson Games](http://www.sjgames.com/). (the Gathering 99 is very pleased to welcome Mr. Jackson\
himself as one of our guests this year!)

***How to Play***

    [GURPS](http://www.sjgames.com/gurps/) is a point-based system of character creation. In some games, like AD&D,\
the player rolls dice to determine the character's abilities; in [GURPS](http://www.sjgames.com/gurps/), the player will\
...
***Don't Panic!***\
    We're in this game to have fun, so it is not necessary to understand the rules. [GURPS](http://www.sjgames.com/gurps/)\
...
[combat](g99_game05.html) or [spellcasting](g99_game06.html) does it get complicated. And even then, it's a lot easier than it\
...
choosing traits such as gender and appearance. Click [here](g99_game09.html) for a list describing the\
...
the racial packages for [Gargoyles](g99_game03.html) or [Third Race](g99_game04.html) and building with 200 points.\
3. If you know what you want but don't know the game system, [e-mail the GM](mailto:vecna@eskimo.com) with a\
...
[GURPS](http://www.sjgames.com/gurps/) rulebooks\
Some refreshments\
...
    Optimally, everyone will rush out and buy a few [GURPS](http://www.sjgames.com/gurps/) books, thereby making our\
gaming GoH Steve Jackson exceedingly happy ...\
    If you do, a **Basic Book**, the **Compendium I**, **Magic**, and **Grimoire** would all be good\
choices ... though [GURPS](http://www.sjgames.com/gurps/) offers worldbooks for just about every genre, from fantasy\
to space to superheroes, and nearly any setting or time period you could wish (or\
even **all** of them; let [GURPS](http://www.sjgames.com/gurps/) **Time Travel** be your own personal Phoenix Gate!)

    But, just in case you don't, click [here](g99_game02.html) for a simplified and hopefully-not-too-\
inaccurate rundown on the game.

Your character will be built on 200 points.\
If you want to be a gargoyle, click [here](g99_game03.html)\
If you want to be of the Third Race, click [here](g99_game04.html)\
 \
 
