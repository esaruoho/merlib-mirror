...
source_path: ~robertf/monorail/prt.html
order: 7035
...
*Source page: `~robertf/monorail/prt.html`*

> **PRT (Personal Rapid Transit)**\
> PRT could be an option to use locally in conjunction with a monorail system.\
> \
>
> Personal Rapid Transit (PRT) is a concept in which small vehicles operate at moderate speed over a fixed guideway, and would probably be operated automatically by a computer system.\
> \
...
> \
> Imagine arriving at 155th and Aurora by the regular full-size monorail train. You would step off the train onto the station platform. You could then step into one of the PRT cars and push a button for your destination, just as you step into an elevator and push the button for your floor.\
> \
...
> \
> An example of a shopping center is Northgate. I propose a monorail station at the Northgate Transit Center [(my route number 2)](my_route.html). A local PRT system could link the monorail station with Northgate Mall (with several stops in the mall), the Best Buy/Target complex north of the mall, strip malls east of the mall along Northgate Way, and an office complex south of the Transit Center. If there is no monorail station at North Seattle Community College, a PRT guideway could cross the freeway to serve the college and offices and other businesses north of the college. In fact, it may be possible to eliminate a monorail station at the college if the local PRT system is built.\
> \
