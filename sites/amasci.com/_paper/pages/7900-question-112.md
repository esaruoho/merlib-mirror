...
source_path: ~scs/C-faq/q11.2.html
order: 7900
...
*Source page: `~scs/C-faq/q11.2.html`*
...
\[Late-breaking news: I've been told that copies of the new C99 can be obtained directly from [www.ansi.org](http://www.ansi.org/); the price for an electronic document is only US \$18.00.\]
...
The text of the Rationale (not the full Standard) can be obtained by anonymous ftp from ftp.uu.net (see question [18.16](q18.16.html)) in directory doc/standards/ansi/X3.159-1989, and is also available on the web at <http://www.lysator.liu.se/c/rat/title.html> . The Rationale has also been printed by Silicon Press, ISBN 0-929306-07-4.

------------------------------------------------------------------------

Read sequentially: <a href="q11.1.html" rev="precedes">prev</a> <a href="q11.3.html" rel="precedes">next</a> <a href="s11.html" rev="subdocument">up</a> [top](faq.html)
