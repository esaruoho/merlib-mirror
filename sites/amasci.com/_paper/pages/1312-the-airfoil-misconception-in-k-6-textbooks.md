---
title: "The Airfoil Misconception in K-6 Textbooks"
source_domain: amasci.com
source_path: ~billb/wing/airfoil.html
order: 1312
...
*Source page: `~billb/wing/airfoil.html`*

[Up to K-6 Textbook Errors](/miscon/miscon4.html) \| [SCIENCE HOBBYIST](/)

# Airfoil Lifting Force Misconception in [K-6](/miscon/k6.txt) Textbooks
...
There also are three other explanations of lift: the circulation explanation, curvature of streamlines explanation, and the vortex-based explanation. These appear in advanced textbooks, and they form the basis of the mathematics used by aircraft designers. The "popular" or "airfoil-shape" explanation commonly appears in children's science books, magazine articles, and in pilot's textbooks. Explanations based upon circulation, on curvature of streamlines, or on Newton's Laws appear there only rarely.\

A POSSIBLE SOLUTION: [Billb's Airplane Flight Analogy](/wing/rotbal.html)\

Explanations which are based on Newton's vs. Bernoulli's principles really aren't as incompatible as many people seem to believe. For the most part they are simply two different ways of simplifying a single complicated subject. Much of the controversy arises because one side or the other insists that only \*THEIR\* view is correct. They insist that only a \*SINGLE\* explanation is possible, and the opposing view is therefore wrong. Which way to crack an egg? It's a war between the Big-endians and Little-endians from GULLIVER'S TRAVELS.\

However, there are also several serious mistakes usually associated with the "popular" explanation described above. People who believe the "popular" explanation wrongly insist that any divided parcels of air must meet again at the trailing edge. This is wrong. They believe that wings don't deflect the oncoming air downwards. These and several other mistakes commonly appear in elementary science texts and in popular articles on aircraft physics. These mistakes change the popular "airfoil-shape" explanation into a system of misconceptions. I explore these below.\
...
- [Why Airfoils Are So Hard to Understand](/wing/whyhard.html)
- [Disk Balloons](/wing/rotbal.html)
- [GIF Diagrams](/wing/airgif2.html)
- [Articles](#articles)
- [Discussions](#dis)
- [Other websites](#sites)
- [References](#refs)
- [Components of the misconception](#parts)
- [Analysis of the two explanations](#expl)
- [ADD YOUR COMMENTS](/~billb/cgi-bin/miscon/guestbook.html) about misconceptions
...
## Bill B.'s Pro-Newton Articles & Misc.Controversy

- [Why Airfoils Are So Hard to Understand](/wing/whyhard.html)
- [Disk balloons](/wing/rotbal.html) explain flight.
  - [J. Denker's review](http://www.monmouth.com/~jsd/fly/rotbal.htm)
    - [My Response](/wing/rotbal2.html)
- [Airfoil Explanations](/wing/wingexp.html)
- [Airfoil GIFs](/wing/airgif2.html) show controversial effects
- [The two explanations](#expl)
- [Parts of the misconception](#parts)
- [References](#refs)
- [C. Swartz editorial](/wing/swartz.txt) from The Physics Teacher
- [GIF of misleading "Bernoulli" diagram](/miscon/wing.gif)
- [GIF of tilted airfoil confusion](/wing/airfoil2.gif)

<span id="dis"></span>

## Discussions, message threads

- [Newsgroup: rec.aviation.piloting](http://groups.google.com/groups?group=rec.aviation.piloting)
- [Newsgroup: rec.aviation.student](http://groups.google.com/groups?group=rec.aviation.student)
- [Newsgroup: rec.aviation](http://groups.google.com/groups?group=rec.aviation)
- [Newsgroup: rec.models.rc.air](http://groups.google.com/groups?group=rec.models.rc.air)
- [Newsgroup: sci.aeronautics.simulation](http://groups.google.com/groups?group=sci.aeronautics.simulation)
- [Newsgroup: sci.physics.computational.fluid-dynamics](http://groups.google.com/groups?group=sci.physics.computational.fluid-dynamics)
- [Misc. received messages](/wing/wcommnt.txt)
- [PHYS-L EMAIL DEBATE](/wing/wphysl2.txt) (Recent)
- [PHYS-L EMAIL DEBATE](/wing/wphysl.txt) (Older)
- [Physics discussion](http://lapphp0.in2p3.fr/~orloff/FF/hgt/physics/) on [Hang Gliding List](http://lapphp0.in2p3.fr/~orloff/FF/)
- [Newton/Bernoulli thread from rec.models.rc.air](/wing/rmrcair.html)

<span id="sites"></span>

### Other websites

- [How Airplanes Fly: A Physical Description of Lift](http://www.aa.washington.edu/faculty/eberhardt/lift.htm) (c) (Anderson & Eberhardt)
- [Coanda Effect Article](http://www.jefraskin.com/forjef2/jefweb-compiled/published/coanda_effect.html) from QUANTUM magazine (Jeff Raskin)
- Two from [K. Weltner](http://www.rz.uni-frankfurt.de/~weltner/)
  - [Misinterpretations of Bernoulli's Law](http://www.rz.uni-frankfurt.de/~weltner/Mis6/mis6.html)
  - [Physics of Flight - reviewed](http://www.rz.uni-frankfurt.de/~weltner/Flight/PHYSIC4.htm)
- [Animations](http://www.idra.unige.it/~irro/profilo1a_e.html) disprove the "wing shape" explanation
- [NASA Glenn Research Center: Beginner's Aerodynamics](http://www.grc.nasa.gov/WWW/K-12/airplane/bga.html)
  - [nasa/grc: the incorrect ""Half Venturi" theory debunked](http://www.grc.nasa.gov/WWW/K-12/airplane/wrong3.html)
  - [nasa/grc: the incorrect "Longer Path" theory debunked](http://www.grc.nasa.gov/WWW/K-12/airplane/wrong1.html)
  - [nasa/grc: Bernoulli vs. Newton](http://www.grc.nasa.gov/WWW/K-12/airplane/bernnew.html)
- [about.com: physics: How Airplanes Don't Fly](http://physics.about.com/library/weekly/aa041401a.htm)
- [Airfoils](http://www.monmouth.com/~jsd/fly/how/htm/airfoils.html) chapter of [SEE HOW IT FLIES,](http://www.monmouth.com/~jsd/) online pilot instruction manual (EXCELLENT!)
- [Discover magazine: and old lofty theory loses altitude](http://www.discover.com/apr_01/featphysics.html)
- [about H. M. Coanda](http://www.allstar.fiu.edu/aero/coanda.htm)
- [Ground Effect](http://home.mira.net/~radacorp/ground_effect.html)
- [Bumblebees cannot fly!](http://www.pbs.org/saf/transcripts/transcript904.htm#4)
- Gale Craig,["How Airplanes Really Fly"](http://www.geocities.com/CapeCanaveral/Hangar/6544/)
- [Irrotational Flow](http://www.idra.unige.it/~irro/) (mini-lecture with animations!)
- [Ground Effect](http://www.cybercom.net/~copters/aero/ground_effect.html) regarding helicopters
  - [Photo Gallery](http://www.diam.unige.it/~irro/gallery.html)
- Downwash doesn't exist? Riiiight. [Great GIF](http://www.efluids.com/efluids/gallery/cessnajet_1.htm) of visible downwash at Princeton's Fluid Dyn. [picture of the week](http://www.efluids.com/efluids/pages/gallery.htm)
- [How Things Work: Wings](http://landau1.phys.virginia.edu/Education/Teaching/HowThingsWork/airplanes.html) (Newton \*AND\* Bernoulli)
- [GIF of downwash](http://www.princeton.edu/~asmits/pow_96_Oct11.html), red smoke is pushed down and outwards, edge curls up.
- [Ground Effect](http://www.se-technology.com/wig/html/main.php?open=aero&code=0) , and [G. E. craft](http://www.se-technology.com/wig/html/main.php?open=listmovies&code=0)
- [Corrections](/wing/nasm.txt) at the [Nat. Air and Space Mus.](http://www.nasm.edu/GALLERIES/GAL109/LESSONS/TEXT/TEASERS.HTM) (Yay!)
- [Online aerodynamics textbook](http://aero.stanford.edu/onlineaero/appliedaero.html)
- [Lift caused by curvature of streamlines](http://www.desktopaero.com/appliedaero/appliedaerodemo/airfoils1/cpandcurvature.html)
- [Newton AND Bernoulli](http://wings.ucdavis.edu/Book/Flight/instructor/lift.html), from [Cislunar Aerospace K-8 Textbook](http://wings.ucdavis.edu/)!
- [J. Johnson article](/wing/johnson.txt) from rec.aviation.student
- [D. Straub article](/wing/straub.txt), from [Physics discussion](http://lapphp0.in2p3.fr/~orloff/FF/hgt/physics/) on [Hang Gliding List](http://lapphp0.in2p3.fr/~orloff/FF/)
- [Gell article](/wing/gell.txt) from rec.models.rc.air
...
### Pro-Newton References

Cliff Swartz, "[Numbers Count](/wing/swartz.txt)", editorial in THE PHYSICS TEACHER, p536, Vol34, Dec 1996
...
Here is the typical "Airfoil shape" or "Bernoilli" explanation of airfoil lift which commonly appears in childrens' science books:\
...
> Uh oh, [wind tunnel photographs](airgif2.html) of lift-generating wings reveal a serious problem with the above description! They show that the divided parcels do not recombine at the trailing edge. Whenever an airfoil is adjusted to give lift, then the parcels of air above the wing move faster than those below, and the lower parcels lag far behind. This even applies to thin flat wings such as a "flying barn door." After the air has passed the wing, the upper and lower parcels of air remain permanently divided. The wind tunnel experiments show that the "wing-shape" argument regarding difference in path-length is simply wrong.\
>
...
>
> If the typical "pro-Bernoulli" or "wing-shape" explanation is correct, then how can symmetrical wings and thin cambered wings work at all? How can rubberband balsa gliders work? Those who support the "airfoil-shape" viewpoint will sometimes suggest that some other method must be used to explain these particular wings. But if so, why then do so many books put forth only the above "pro-Bernoulli" explanation as the single explanation of aerodynamic lift? Why do they avoid detailing or even mentioning any other important explanations of lifting force?\
>
...
>
> The above "pro-Bernoulli" viewpoint would predict that the addition of a lump to the top of a wing should always increase the lift (since it increases the upper surface path length.) In fact, the addition of a lump does not increase lift. This suggests that there is a problem with the "Bernoulli/wingshape" explanation of lift.\
>
> Forces on sailboat sails are explained using the typical "Bernoulli/wingshape" explanation above. But sailboat sails are thin cloth membranes with identical path-lengths on either side. Why should air on either side of a sail have different velocities if the path length is the same?\
>
> Children have experience with rubberband-powered balsa wood aircraft having wings composed of a single flat layer of very thin wood. Paper airplanes usually have flat thin wings. These aircraft cannot fly? How can the "pro-Bernoulli" version explain their successful operation?\
>
