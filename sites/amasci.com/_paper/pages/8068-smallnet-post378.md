---
title: "SMALLnet post378"
source_domain: amasci.com
source_path: ~smallnet/Archive/post378.html
order: 8068
...
*Source page: `~smallnet/Archive/post378.html`*
...
Ron Stanfield \< <StanfieldR@aol.com> \> chimes in with:
...
Mike Blott \< <DRBLOTT@aol.com> \> reports:
...
Dohrm Crawford \< <tum25@mindspring.com> \> contributed:
...
Ed Toner \< <captained@home.com> \> avers:
...
Randy Randolph \< <randyranman@juno.com> \> recommends:
...
Charlie Fries \< <c.s.fries@juno.com> \> writes:
...
> \< <a href="mailto:takeoff" data-@tele-net.net="">takeoff @tele-net.net</a> \>\

Ron Fikes, Palo Alto, California

Zach Allerton \< <enyaxx@hotmail.com> \> contributed:
...
<span id="260">Source: Plans, Tomboy\
</span> The Tomboy plan is listed in the 1996 Nexus Plans Service catalog -- plan no. PET 398. I don't know if they have an e-mail address now. Their fax number is 01442 66998 in the UK. The US agent used to be Bob Holman plans, and you can reach Bob at \< <bhplans@aol.com> \>.
...
Sandy Ross \< <sclross@telus.net> \> amplifies:

<span id="305">Source: Plans, Tomboy\
</span> In response to Peter Helms request for Tomboy plans, these can be ordered online at \< <http://www.nexusonline.com> \>. It is a Vic Smeed design, and the plans show either 36" or 44" wingspan.

Regards, Sandy Ross

Peter Helm \< <helm@pnc.com.au> \> responds:
...
Curt Hulett \< <rchulett@swbell.net> \> wrote:
...
Joe Ross \< <w5bsa@earthlink.net> \> asked:
...
<span id="361">Source: Bill Northrop's Plans Service\
</span> <span id="362">Source: Plans, Bill Northrop's Plans Service\
</span> ...Plans for ALL the models that appeared in Model Builder -- including the peanut-sized rubber-powered free flight scale models mostly designed by the late, great Walt Mooney -- are available from Bill Northrop's Plans Service, 2019 Doral Court, Henderson, Nevada 89014 --- (702) 896-2162 (Mon-Fri, 10 AM - 5 PM Pacific Time) --- e-mail: \< <northroplans@earthlink.net> \>.
...
Ken Phillips \< <kgphilli@airmail.net> \> inquires:
...
Dave Fritzke \< <DFRITZKE@ci.crystal.mn.us> \> asks:
...
Dennis Leonhardi \< <AeroClassix@USFamily.net> \> wrote:
...
John Reid \< <jands.reid@clear.net.nz> \> submitted:
...
George Aldrich \< <amadist8@satx.rr.com> \> reports that his health is improving a little, and suggests:

<span id="482">Source: Head Gaskets\
</span> For glow head gaskets try the Lite Machine Corp. in West Lafayette, Indiana. (317) 463-0959. They also make the old GlowBee plugs ! GMA

Ron Boucke' \< <RBoucke@aol.com> \>
...
Bill Thomas \< <thomasb@ruraltel.net> \> announced:
...
The other is a Global "Schoolboy" A.R.F. It's also N.I.B. and for an .09 to .15 motor. I will accept the best reasonable offer. Please reply direct to \< <thomasb@ruraltel.net> \>. Bill
