---
title: "Private Idaho Online Help"
source_domain: amasci.com
source_path: ~joelm/pihelp.html
order: 3988
...
*Source page: `~joelm/pihelp.html`*

# <img src="pi.gif" width="156" height="28" alt="Private Idaho" />

## Version 2.8b Online Help

3/04/98 - *copyright (c)1995, 1996, 1997, 1998  Joel McNamara (<joelm@eskimo.com>)*

------------------------------------------------------------------------

[Overview](pihelp.html#overview)

[What's new in 2.8](#new)

[System Requirements](#sysreq)

[Where to Get Private Idaho](pihelp.html#get)

[Installation](#install)

General Configuration

[Updating Remailer/USENET Info](#update)

[Specifying e-mail information](#emailinfo)

[Connecting to the Internet](#connect)

[Using an Address Book](#address)

[Using Expert and User modes](#expert)

[Using OS/2 delay](pihelp.html#os2)

[Installing the remailer and nym server PGP public keys](pihelp.html#installkeys)

[Controlling the behavior of the PGP DOS box](#DOS)

[Setting PGP options](#PGPOpts)

[Loading your passphrase into memory at start-up](#startpass)

[Using ViaCrypt PGP](#viacrypt)

[Changing e-mail transfer settings](#change)

[Adding your own e-mail software specifications](#addapp)

[Saving Private Idaho settings](#saveset)

[Auto encrypt/decrypt of settings](#Auto-encrypt/decrypt%20of%20settings)

[Auto encrypt/decrypt of secret and public key rings](#cryptrings)

[Sending feedback](#feedback)

Encrypting & Decrypting

[Encrypting a message](#encrypt)

[Encrypting and signing a message](#encryptsign)

[Signing a message](#sign)

[Using multiple keys to sign a message](#multsign)

[Decrypting a message](#decrypt)

[Using multiple keys](#encryptmult)

[Using "encrypt to self"](#enself)

[Using "eyes only"](#eyes)

[Using conventional encryption](#conv)

[Using "obscurity"](#obscur)

[Using word wrap](#wrap)

[Using a file as input](#file)

Key management

[Creating a new key pair](#keypair)

[Adding a key to your public ring](#addkey)

[Deleting a key from your public ring](pihelp.html#delkey)

[Inserting a public key in your message](#insertkey)

[Updating Private Idaho's public key ring information](#updatekey)

[Requesting a key from the MIT key server](#requestkey)

[Adding a key to the MIT key server](#submitkey)
...
[Transferring a message to your e-mail software](#trans)

[Importing or exporting a message](#importexport)

[Using a header or signature (sig) in a message](#headsig)

[Using word wrap](#wrap)

[Using X-Headers](#xheaders)

Remailers

[Sending mail through a single remailer](#remailone)

[Sending mail through multiple remailers](#remailchain)

[Encrypting mail and sending it through a remailer](#encsendrem)

[Using the Append on Send option](#aes)

[Using Cypherpunk remailer advanced features](#cpadvance)

[Encrypt to remailer(s)](#cpenc)

[Replace subject](#cprep)

[Use latent time](#cplat)

[Use cutmarks](#cpcut)

[Post to USENET](#cpuse)

[About Mixmaster remailers](#mix)

USENET

[Posting anonymously to a USENET newsgroup](#anonpost)

[Posting anonymously through a USENET gateway](#anongate)

[Using gateways that require a newsgroup header](#gatewayheader)

Receiving PGP messages

[Introduction](#intropgprec)

[Scanning for PGP messages](#pgpscan)

[Showing PGP messages](#pgpshow)

Using Nym Servers

- [What is a nym?](#nym)
- [Creating a nym account](#nymcreate)
- [Deleting a nym account](#deletenym)
- [Adding an existing nym account](#existnym)
- [Changing your nym reply block](#nymchange)
- [Changing your nym password](#nympass)
- [Encrypting a nym message](#nymencrypt)
- [Preparing a nym message](#nymprep)
- [Showing nym server statistics](#nymstats)
- [Nym notes](#nymnotes)
- [Nym/USENET FAQ](#Nym/USENET)

Miscellaneous information

[Accessing a Web browser](#webaccess)

[Anonymously accessing Web pages](#anonweb)
...
[Mail server and Winsock connections](#mailserver)

[Scanning for PGP messages](#scanpgp)

[Windows NT](#nt)

[PGP doesn't use correct key](#secretkey)

[PGP and Mixmaster icons in Win95 taskbar](#taskbar)

[USENET messages don't get posted](#nousenet)

[Messages or Web links don't transfer correctly](#notransfer)

[NYMS.TXT not formatted correctly and "File past end of input" in NYMS.TXT](#nyminput)

[No "To:, From:, Subject:" headers appear in main window](#noheaders)

[Temp file problems](#tempfile)

[Mixmaster doesn't run correctly](#mix)

[Command line greater than 128 characters](#cmdline)

[Multiple .ASC files for attachments](#multipleASC)

[Known issues](#bugs)

[Command Summary](#commands)

[Credits and other things](#things)

------------------------------------------------------------------------

### <span id="overview"></span>Private Idaho Overview
...
Due to a variety of projects and other directions, I've had to considerably cut back the amount of time I devote to Private Idaho. Because of this, I've decided to make the Visual Basic source code available under the terms of the GNU General Public License agreement. If you're a developer, you might be interested. [Here's the details.](http://www.eskimo.com/~joelm/pi.html)[](http://www.eskimo.com/~joelm/pi.html)

All the work I did on Private Idaho was centered around a 16-bit version that would run under Windows 3.x and Windows 95. Since releasing the sources to the public, several folks have released [32-bit versions](http://www.eskimo.com/~joelm/pi.html).\

------------------------------------------------------------------------

### <span id="new"></span>What's new in 2.8
...
### <span id="sysreq"></span>System Requirements
...
(Pretty Good Privacy - 2.6.2 is the latest MIT version, or use the latest "I" version out of the United States - if you're using the commercial ViaCrypt Windows version, see the section on [Using ViaCrypt PGP](#viacrypt).)

***VBRUN300.DLL (Visual Basic runtime)***

Most people seem to have a copy of this file. It isn't included with Private Idaho because of the size. If you need it, get it [here](ftp://ftp.eskimo.com%20/u/j/joelm). Then move it to the \WINDOWS\SYSTEM directory.\

------------------------------------------------------------------------

### <span id="get"></span>Where to Get Private Idaho

Latest releases of Private Idaho are available from the main distribution point:

FTP - [ftp.eskimo.com /u/j/joelm](ftp://ftp.eskimo.com%20/u/j/joelm)
...
These sites may not have up-to-date releases:

- [ftp.cts.com/pub/jrcffmn](ftp://ftp.cts.com/pub/jrcffmn)
- [ftp.ox.ac.uk/pub/crypto/pgp/pc](ftp://ftp.ox.ac.uk/pub/crypto/pgp/pc)
- [ftp.nus.sg:/pub/zq/pidaho](ftp://ftp.nus.sg:/pub/zq/pidaho)

Or, try an [FTP search](http://ftpsearch.unit.no/) for Private Idaho or PIDAHO.EXE (lots of European sites).

------------------------------------------------------------------------

### <span id="install"></span>Installation

Private Idaho is distributed in a self-extracting .ZIP file (PI28b3.ZIP). Create a directory, move the distribution file to it, and run it to uncompress all required files. You can delete these files after you've installed Private Idaho. The PI-Setup program will automatically install Private Idaho and all required support files for you. The files copied to the PIDAHO directory include:
...
Files copied to the \WINDOWS\SYSTEM directory include:
...
You can also choose to run PGP QuickStart from Setup . This utility will help you download and configure PGP.
...
### <span id="update"></span>Updating Remailer/USENET Info

Remailers and USENET mail gateways come and go and vary in reliability. You'll want to make sure you have the most up-to-date information before using a remailer.
...
MIXMASTE.HTM contains statistics on Mixmaster Type II remailers.

PUBRING.MIX contains Mixmaster remailer keys.

TYPE2.LIS contains list of Mixmaster remailers.
...
### <span id="connect"></span>Connecting to the Internet
...
### <span id="expert"></span>Using Expert and User modes
...
### <span id="address"></span>Using an Address Book
...
### <span id="os2"></span>Using OS/2 Delay
...
### <span id="installkeys"></span>Installing remailer and nym server PGP public keys
...
### <span id="emailinfo"></span>Specifying e-mail information

If you use an Internet provider that supports sending e-mail through a SMTP (Simple Mail Transport Protocol) mail server, the most commonly used type, you can send messages directly from Private Idaho without using another e-mail application. If your Internet provider supports receiving messages through POP3, you can have Private Idaho check your mailbox for PGP encrypted messages.
...
### <span id="saveset"></span>Save Private Idaho settings
...
### <span id="Auto-encrypt/decrypt of settings"></span>Auto-encrypt/decrypt of settings
...
### <span id="cryptrings"></span>Auto-encrypt/decrypt of secret and public key rings
...
**Warning:** If you forget the passphrase used to encrypt the key rings, you're going to be out of luck. That's a 128 bit IDEA key which will roughly take 5.4 x 10<sup>18</sup> years to brute force based on 10<sup>6</sup> encryptions per microsecond. Otherwise, be sure you've got a back-up of your key rings.
...
### <span id="feedback"></span>Sending feedback

Choose the "Send feedback" command from the Help menu. Text in the message box will be erased, and a new message will be addressed to me, ready for your comments.
...
Due to a variety of other projects, I've had to drastically cut back on the amount of e-mail support I provide for Private Idaho. Bug reports will be logged and suggestions will be noted, but at this point, don't hold your breath waiting for an e-mail reply from me. If Private Idaho doesn't seem to work right, check the [Troubleshooting](http://www.eskimo.com/~joelm/pihelp.html) section in the on-line documentation. I'll try to keep this current with common problems.

Another excellent source of information is the [alt.security.pgp](news:alt.security.pgp) USENET newsgroup. There's quite a few Private Idaho users there, and often they'll answer posted questions.\

------------------------------------------------------------------------

### <span id="encrypt"></span>Encrypting a message
...
### <span id="encryptsign"></span>Encrypting and signing a message
...
### <span id="sign"></span>Signing a message
...
### <span id="multsign"></span>Using multiple keys to sign a message
...
### <span id="decrypt"></span>Decrypting a message
...
### <span id="importexport"></span>Importing or exporting a message
...
### <span id="headsig"></span>Using a header or signature (sig) in a message
...
### <span id="encryptmult"></span>Using multiple keys
...
### <span id="enself"></span>Using "encrypt to self"
...
### <span id="eyes"></span>Using "eyes only"
...
### <span id="conv"></span>Using conventional encryption
...
### <span id="obscur"></span>Using "obscurity"
...
### <span id="wrap"></span>Using word wrap

If the "Word wrap on encrypt/sign" menu item is checked, Private Idaho will insert carriage returns at the end of each line in the message text box. This is useful when sending messages to users with mail software that doesn't support automatic word wrap. The actual word-wrapping is performed only before a message is encrypted or signed.
...
### <span id="file"></span>Using a file as input
...
### <span id="keypair"></span>Creating a new key pair
...
### <span id="addkey"></span>Adding a key to your public ring
...
### <span id="delkey"></span>Deleting a key from your public ring
...
### <span id="insertkey"></span>Inserting a public key in message
...
### <span id="updatekey"></span>Updating Private Idaho's public key ring information
...
### <span id="requestkey"></span>Requesting a key from the MIT key server
...
### <span id="submitkey"></span>Adding a key to the MIT key server
...
### <span id="DOS"></span>Controlling the behavior of the PGP DOS box
...
### <span id="PGPOpts"></span>Setting PGP options

Choose the "Options..." command from the PGP menu.
...
You can also specify to [auto-encypt/decrypt](#cryptkeys) your secret and public key rings for additional security.
...
### <span id="startpass"></span>Loading your passphrase into memory at start-up
...
### <span id="viacrypt"></span>Using ViaCrypt PGP

Previous versions of Private Idaho supported ViaCrypt's PGP for Windows version 2.7.1. Unfortunately, the latest 4.0 release has been changed significantly so Private Idaho can't support it. Because of this, and the relatively small number of users, Private Idaho 2.8 no longer supports ViaCrypt.
...
### <span id="send"></span>Sending mail
...
### <span id="attachments"></span>Sending attachments

You can include attachments with e-mail messages you send directly from Private Idaho. Attachments are Base64 encoded and are MIME compliant.
...
### <span id="xheaders"></span>Using X-Headers
...
### <span id="remailone"></span>Sending mail through a single remailer
...
### <span id="remailchain"></span>Sending mail through multiple remailers
...
### <span id="aes"></span>Using the Append on send option
...
### <span id="encsendrem"></span>Encrypting mail to send through an anonymous mailer
...
### <span id="cpadvance"></span>Using Cypherpunk remailer advanced features
...
### <span id="cpenc"></span>Encrypt to remailer(s)
...
### <span id="cprep"></span>Replace subject
...
### <span id="cplat"></span>Use latent time
...
### <span id="cpcut"></span>Use cutmarks
...
### <span id="cpuse"></span>Post to USENET
...
### <span id="mix"></span>About Mixmaster remailers
...
### <span id="anonpost"></span>Posting anonymously to a USENET newsgroup
...
Wil Ussery has put together some pretty good [FAQs](http://www.zoom.com/personal/wussery/pgp.html) on how to use Private Idaho to post anonymously to USENET newsgroups and how to use it with nym servers. Thanks Wil!\

------------------------------------------------------------------------

### <span id="gatewayheader"></span>Using gateways that require a newsgroup header
...
### <span id="trans"></span>Transferring a message to your e-mail software

1\. Make sure the e-mail software (Eudora, Pegasus, etc.) is running, a blank, new message in the e-mail software is in front, and the cursor is on the To: line. Do not minimize/iconize the e-mail application.
...
### <span id="change"></span>Changing e-mail transfer settings

The Transfer Options command in the Message menu contains the settings used to transfer a message from Private Idaho to the e-mail software you are using. This information must be correct for a valid transfer to take place.
...
Each of the commands instructs Private Idaho what information or key should be sent to the e-mail application. (Header lines are automatically sent with a following Tab.)
...
### <span id="addapp"></span>Adding your own e-mail software specifications

The EMAIL.TXT file contains specifications for a variety of e-mail packages. Up to 12 e-mail apps will be displayed in the dialog box when you choose Options from the Transfer menu.
...
Private Idaho reads 3 lines in at a time and associates it with a button. When you press the button, the information is filled in.\

------------------------------------------------------------------------

### <span id="intropgprec"></span>Introduction to receiving PGP messages
...
### <span id="pgpscan"></span>Scanning for PGP messages
...
### <span id="pgpshow"></span>Showing PGP messages
...
### <span id="nym"></span>What is a nym?
...
### <span id="nymcreate"></span>Creating a nym account
...
### <span id="existnym"></span>Adding an existing nym account
...
### <span id="deletenym"></span>Deleting a nym
...
### <span id="nymchange"></span>Changing your nym reply block
...
### <span id="nympass"></span>Changing your nym password
...
### <span id="nymencrypt"></span>Encrypting a nym message
...
### <span id="nymprep"></span>Preparing a nym message
...
### <span id="nymstats"></span>Showing nym server stats
...
### <span id="Nym/USENET"></span>Nym/USENET FAQ

<thanatopsis@nym.alias.net> provides this excellent FAQ on using nym servers to post to USENET newsgroups:
...
\- -----BEGIN PGP MESSAGE-----\
Version: 2.6.2\
(your encrypted or plain-text message)\
- -----END PGP MESSAGE-----
...
The remailer you're sending through should still be in the "To:" box.
...
### <span id="nymnotes"></span>Nym notes
...
### <span id="webaccess"></span>Accessing a Web browser
...
[Get the latest PGP (US residents)](http://web.mit.edu/network/pgp-form.html) - accesses MIT's PGP distribution page. You must be a US resident to download PGP from this source.

[Get the latest PGP (rest of world)](http://www.mantis.co.uk/pgp/pgp.html) - accesses a page of links with sites outside of the US where PGP can be downloaded.

[Access the MIT key server](http://www-swiss.ai.mit.edu/~bal/pks-toplev.html) - accesses a page where you can store your PGP public key in a database as well as search for other people's. This is a free central database that get's global use.

[Read the official PGP FAQ](ftp://ftp.prairienet.org/pub/providers/pgp/pgpfaq.txt) - accesses the official PGP Frequently Asked Question list. Most of your questions can be answered here.

[Get the short PGP FAQ](ftp://ftp.csn.net/mpj/getpgp.asc) - accesses a shorter version of the PGP FAQ, with information on the latest version, where to get PGP, and different types of shells to use.

[Learn about crypto and privacy](http://world.std.com/~franl) - accesses the privacy and cryptography section of the WWW Virtual Library. Excellent information on PGP, crypto, and electronic privacy issues.

[Browse alt.security.pgp](news:alt.security.pgp) - accesses the USENET alt.security.pgp newsgroup. This is the place for breaking information, answers to easy and hard questions, and interesting political discussion.

[Get remailer information](http://www.sendfakemail.com/~raph/remailer-list.html) - accesses remailer information you can use to update the RMINFO, CPMAILER, and Mixmaster files Private Idaho uses. Also provides links to other remailer information sources.

[Go to EFF](http://www.eff.org) - accesses the Electronic Frontier Foundation's home page. An excellent source of information on electronic privacy issues.

[Go to EPIC](http://www.epic.org) - accesses the Electronic Privacy Information Center's home page. An excellent source of information on electronic privacy issues.

[Go to CPSR](http://www.cpsr.org/home) - accesses the Computer Professionals for Social Responsibility home page. An excellent source of information on electronic privacy issues.

[Get the latest Private Idaho](http://www.eskimo.com/~joelm/pi.html) - accesses the central page for Private Idaho distribution. You can check for any updates and download them.
...
### <span id="anonweb"></span>Anonymously accessing a Web page

***NOTE: This service may or may not be available.***

[Community Connexion - http://www.c2.org](http://www.c2.org) (a privacy oriented Internet Service Provider) offers a free Web ["anonymizing" service](http://www.anonymizer.com). It's relatively easy for someone to track what information you access on the Web. However by using the anonymizer with your browser, the owner of the Web page you accessed won't know your identity.
...
### <span id="trouble"></span>Troubleshooting
...
<span id="pubkeys"></span>***PUBKEYS.OUT***
...
<span id="mailserver"></span>***Mail Server and Winsock Connections***
...
<span id="scanpgp"></span>***Scanning for PGP messages***
...
<span id="secretkey"></span>***PGP doesn't use correct secret key***
...
<span id="taskbar"></span>***PGP and Mixmaster icons in Windows 95 taskbar***
...
<span id="nousenet"></span>***USENET messages don't get posted***
...
<span id="notransfer"></span>***Messages or Web links don't transfer correctly***
...
<span id="nyminput"></span>***NYMS.TXT not formatted correctly and "File past end of input" in NYMS.TXT***
...
<span id="tempfile"></span>***Temp file problems***
...
<span id="mix"></span>***Mixmaster doesn't run correctly***
...
<span id="cmdline"></span>***Command line greater than 128 characters***
...
<span id="multipleASC"></span>***Multiple .ASC files for attachments***
...
<span id="bugs"></span>***Known issues***
...
### <span id="commands"></span>Command Summary
...
### <span id="things"></span>Credits and other things

Thanks to **Colin Tan** for help with the Setup application, **John Deters** for the NT fix, **John Coffman** for help with AOL settings and distribution and a mirror site, **Ned Brickley** and **Paul Leyland** for mirror sites, **Robert Fries** for doing the original Windows help, **Lance Cottrell** for a DOS version of Mixmaster, **Jim Ray** for many owed beers, **Fred Ringel** for the PGP Users list and a mirror site, the faithful and brave beta testers from PI_LIST, and everyone that's taken the time to send me feedback.

Other things:

- There's more to this site than just Private Idaho, [check it out](http://www.eskimo.com/~joelm/index.html)...
