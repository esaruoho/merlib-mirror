...
source_path: ~wesn/waflyfishers/msg07646.html
order: 10083
...
*Source page: `~wesn/waflyfishers/msg07646.html`*

------------------------------------------------------------------------

\[[Date Prev](msg07645.html)\]\[[Date Next](msg07644.html)\]\[[Thread Prev](msg07657.html)\]\[[Thread Next](msg07686.html)\]\[[Date Index](date4.html#07646)\]\[[Thread Index](index.html#07646)\]
...
- *From*: Charlie Mastro \<<cmastro@uswest.net>\>
- *Date*: Mon, 03 Dec 2001 21:59:40 -0800
- *Delivered-To*: fixup-waflyfishers@eskimo.com@fixme
- *In-Reply-To*: \<[v04220808b831a470c0d8@\[192.168.1.221\]](msg07615.html)\>
- *Reply-To*: <waflyfishers@eskimo.com>
- *Resent-Date*: Tue, 4 Dec 2001 08:01:54 -0800
- *Resent-From*: waflyfishers@eskimo.com
- *Resent-Message-ID*: \<"RityG2.0.hG6.nDF3y"@mx1\>
...
------------------------------------------------------------------------
    ...
    The first one was an '87 Mazda long bed, 4 cylinder, 2 WD with a custom made
    canopy and rack. I slept in the back, put bikes, kayaks, pontoon boots, surf
    boards and such on the racks and put 260,000 miles on it in 14 years.  I
    built some boxes in the back so I had a flat area to sleep on and my camping
    gear and rods were stored under.  It was a great truck and was near death
    when I traded in (overheated on the way down to Pullayup to pick up the new
    one).

    Well I think I have just about reached truck nirvana.  I got a Red '91
    Toyota 4 WD, V-6, extended cab with AC.  I now have enough power to actually
    ...
    have much ground clearance and I was always worried about getting stuck. Now
    I fear no road...

    I just got back from Bend over Thanksgiving and ran into 6 to 8 inches of
    snow and two mountain passes and was I glad I had the 4WD.  The AC made the
...
- **References**:
  - **<a href="msg07615.html" id="07615">Fishing vehicles?</a>**
    - *From:* Kent Lufkin \<klufkin@l2d.com\>

<!-- -->

- Prev by Date: **[Re: Fishing vehicles?](msg07645.html)**
- Next by Date: **[Re: Fishing vehicles?](msg07644.html)**
- Prev by thread: **[RE: Fishing vehicles?](msg07657.html)**
- Next by thread: **[Re: Fishing vehicles?](msg07686.html)**
- Index(es):
  - [**Date**](date4.html#07646)
  - [**Thread**](index.html#07646)
