...
*Source page: `~cwn/faq.html`*

[\[Back to Main Page\]](index.html)\
 \
 \

<u>Frequently Asked Questions and Other Notes</u>

Last Changed:  April 17, 2000
...
**General Notes about the patterns:**

        All the patterns on this web site are on 8.5 inch by 11 inch graph paper. The large squares on the paper are 1 inch by 1 inch. If you print the patterns as 8.5 inches by 11 inches with no margins they will be full scale.\
        The web site and the patterns are copyrighted, but this is only to stop someone from publishing them without giving me credit. Feel free to use any of the patterns on this site to make armour for personal use or for sale.\
 \
 

**How to print the patterns:**

    From Redhat Linux 5.x/6.x with xv (Should work on any Linux or UNIX with "xv"):
...
**[Notes on hardening 1050 Carbon Steel](hardening.html)**\
 \
 

**How to dish the halves of the helmet tops :**

        I dish the helmet halves with a 4" solid steel ball welded to the end of a 18" long 1" thick steel bar. I use the bar as a handle and pound the plate into a dishing form using the steel ball. For a dishing form I use the bottom of an old oxygen tank that has been cut off and welded to a steel plate. The bottom of most large (200 cubic foot) oxygen tanks are concave.\
        You can buy "ball stakes" and dishing forms from Iron Monger Armory   <http://www.kingslayer.com/imap01.htm> .  If you order from him be sure to tell him that you want a dishing form for helmet tops. Also let him know that you want to use the ball stake as a dishing hammer. The larger ball stakes come with thicker posts (about 2" thick). If you want to use one as a hammer the post should about 1" thick by 18" to 24" long.\
 \
 

**How to dish couters (elbow cops) and knee cops:**
...
**How do I make spring pins to keep a visor closed?**
