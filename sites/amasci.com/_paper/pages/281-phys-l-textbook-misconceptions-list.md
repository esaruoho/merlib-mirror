---
title: "PHYS-L TEXTBOOK MISCONCEPTIONS LIST"
source_domain: amasci.com
source_path: miscon/physl.html
order: 281
...
# PHYS-L TEXTBOOK MISCONCEPTIONS LIST

*Source page: `miscon/physl.html`*
...
# TEXTBOOK PHYSICS MISCONCEPTIONS

## from [PHYS-L](http://amasci.com/scilists.html) physics teaching discussion

    Updated 2/12/98. DO NOT REPLY TO THIS MESSAGE. USE THE THREAD "ABOUT THE
    LIST" IF YOU WANT TO POST A COMMENT. OR START A THREAD DEVOTED TO AN ITEM.
     
    Contact me (kowalskiL@alpha.montclair.edu) IN PRIVATE if you want to
    remove some of YOUR items or reedit them. Or send additional items to me
    ALSO IN PRIVATE. Let us follow the suggestion that POSITIVE is used
    instead of NEGATIVE; I changed my item 4 to accomplish this. Also COMMON
    misconceptions found in many TEXTBOOKS, not student misconceptions. I do
    not think that we should compete with The Physics Teacher column of Mario
    Iona (who goes after individual authors, documenting everything, etc.) If
    you feel that a reference is important for an item send it to me and I
    will append it at the list of references. 

                         Ludwik Kowalski, (kowalskiL@alpha.montclair.edu)

                A LIST OF (CORRECTED) TEXTBOOK MISCONCEPTIONS
                    *************************************
     
      1) The Physics of Flight: It's air-deflection, not wing shape
      ...
      6) Diagram of free jets from side of water tank, wrong trajectories
     ...
     18) For every motion there is not equal and opposite motion.  Newton's
         3rd law is about force-pairs, an "acting-upon," and no "action" 
         such as throwing bricks from a skateboard or a canoe is required.
     ...
     21) The Physics of Flight: It's air-deflection, not asymmetrical wing shape
     ...
     25) Light rays entering the eye change direction mostly at the cornea,
         not at the internal lens. (more common in Biology texts).
     ...
     29) Laser light is not inherently parallel.  Actually, classroom lasers
         produce spreading light, and manufacturers include a small lens on
         the HeNe tube to parallelize the beam.
     ...
     31) "Electricity" is not a form of energy.  Electrical energy is EM, it
          is photons.  So, "Electricity" is not a spot on the EM spectrum.
     ...
     35) Batteries are good conductors.  The path for an electric current is
         normally into, THROUGH, then back out of the battery.  A battery is 
         not a capacitor, and only stores chemical fuel, not charge.
     ...
     36) 2-plate capacitors are charged with energy, not with electrical
         ...
         particles as a discharged capacitor.  Inductors, capacitors,
         resistors etc. are current-paths, are "conductive."
     ...
     41) "Static electricity" applies to all circuits, not just to dryer-
         ...
         cause of electric currents in circuits.  See Chabay and Sherwood.
     ...
     47) "Electricity" is defined as charge (Maxwell does this, so does Millikan,
         Thompson, Heaviside, Einstein, Lodge, etc.  So does the CRC handbook.)
         Most schoolbooks instead define "electricity" as current, even describing 
         a flow of "Current Electricity" through wires. 

     48) There is no "conservation of current."  Electric current can appear
         from nothing, as with induction.  See Charge Conservation Law.  
         Charge carriers exist, but "current carriers" do not.

    .....................................................................

<http://amasci.com/miscon/physl.html>\
