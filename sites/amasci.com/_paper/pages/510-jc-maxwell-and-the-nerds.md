---
title: "JC Maxwell and the Nerds"
source_domain: amasci.com
source_path: amateur/nerdsmax.html
order: 510
...
# JC Maxwell and the Nerds

*Source page: `amateur/nerdsmax.html`*
...
<tbody>
<tr>
<td><strong><a href="http://amasci.com/we-nerds.html">NERDS PAGE</a>  |</strong><br />
</td>
...
From *[The Demon-Haunted World](https://www.amazon.com/Demon-Haunted-World-Science-Candle-Dark/dp/0345409469/sciencehobbyist)* by Carl Sagan (Headline, 1996)
...
> "Ye years roll on, and haste the expected time When flogging boys shall be accounted crime."
...
**V**x **B** = m<sub>0</sub> ****j**** + m<sub>0</sub>e<sub>0</sub> d**E**/dt
...
d**E**/dt and d**B**/dt represent the time variation, the rate of change of the electric and magnetic fields. **j** stands for the electrical current. The lower-case Greek letter r (rho) represents the density of electrical charges, while e<sub>0</sub> (pronounced 'epsilon zero') and m<sub>0</sub> (pronounced 'mu zero') are not variables, but properties of the substance **E** and **B** are measured in, and determined by experiment. In a vacuum, e<sub>0</sub> and m<sub>0</sub> are constants of nature.
...
**V x B** = m<sub>0</sub> e<sub>0</sub>**dE/dt**

He set r equal to zero, indicating that there are no electrical charges. He also set **j** equal to zero, indicating that there are no electrical currents. But he didn't discard the last term in the fourth equation, m<sub>0</sub> e<sub>0</sub> d**E**/dt, the feeble displacement current in insulators.
...
[Modern Physics Topics](http://web.archive.org/web/20030802114931/www.physics.hku.hk/~tboyce/modern_physics/topics/topics.html)

\
     WANT MORE JC MAXWELL?\

     I've found that greatest, most awesome Sci. History book evar is: [THE MAXWELLIANS](https://www.amazon.com/Maxwellians-Cornell-History-Science/dp/0801482348/sciencehobbyist), by BJ Hunt (1991).\
     Maxwell himself died young, and this book gets into the immediate post-Maxwell era, as more and more top\
     physicists became Maxwell-groupies and started spreading the gospel. I bought two copies, to foist it off on friends.\
     Help spread the word! JC Maxwell should be MORE famous even than ...Nilkola Tesla!     *- bill b.*\

[http://amasci.com/amateur/nerdsmax](http://amasci.com/amateur/nerdsmax.html)\
Mirrored by [Bill Beaty](http://amasci.com/billb.html).\
