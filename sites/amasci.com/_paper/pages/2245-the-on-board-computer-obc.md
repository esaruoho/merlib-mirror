---
title: "The On-Board Computer (OBC)."
source_domain: amasci.com
source_path: ~dalus/bmw/repair_faqs/obc.html
order: 2245
...
*Source page: `~dalus/bmw/repair_faqs/obc.html`*

<span id="contents"></span> This page was originally hosted here: <http://cbsgi1.bu.edu/bmw/bmw_new.html>. But that site has gone down so I'm hosting these pages here.
...
- [Undocumented Features.](obc.html#undoc)
- [Fixing the backlight.](obc.html#fixlight)
- [The PPPP Problem.](obc.html#pppp)
- Also check the <a href="http:/~dalus/bmw/ftp/bmw/FAQ.7" target="_top">Electrical FAQ</a>
...
**OBC car/engine designators and firmware number.**
...
For what this bit of knowledge is worth to anyone....... No other test functions on that type OBC but you'd need a book to discuss the E32/4 type.\
...
Display Test .. all LCDs and LEDs activate

2

Current Consumption in l/100km

3

Current Consumption in l/hour

4

Average Consumption (used to calc. Range)
...
Average Speed (km/h) for calc. ETA
...
Alarm Changeover (continuous v. intermittent)
...
Correction Factor for OBC Fuel Consumption (SEE BELOW!)

21

Reset all defect codes, date and time ... activate by pressing SET/RES
...
- Verify by entering test 19 again. Display should show FREE
...
The procedure to show the version number also differs from the FAQ. On the E34 OBC, you need to press the 100 and 1 buttons simultaneously, to display the type/version (Mine shows '5-00TYP').

------------------------------------------------------------------------

[(return to contents)](obc.html#contents) <span id="fixlight"></span>

# Fixing the backlight:

This is about a 1988 325is, but many other models are similar.

A variation of this note appeared in the Feb., 1994 Roundel and is included in the "BMW Enthusiasts Companion" book published by [Bentley.](bentley.html)
...
Here is another person's experience. Note this is in conflict with the above--namely in that the OBC comes out toward the front and is held in by nuts not phillips screws. Maybe BMW used different methods. I think sometime in the early 90's the OBC does snap out toward the front simply by prying with a credit card. (can somebody verify this and [e-mail me.](mailto:shank@bu.edu?subject=OBC%20update)
...
[(return to contents)](obc.html#contents)
