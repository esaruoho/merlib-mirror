---
title: "Border-Style - Cascading Style Sheets Properties"
source_domain: amasci.com
source_path: ~bloo/indexdot/css/properties/border/bstyle.htm
order: 1441
...
# Border-Style - Cascading Style Sheets Properties

*Source page: `~bloo/indexdot/css/properties/border/bstyle.htm`*
...
<tbody>
<tr>
<td rowspan="2"><h1 id="border-style" class="pagetitle">border-style</h1>
<strong><a href="../../../misc/suppkey.htm">Support Key:</a></strong> [<strong><em>CSS1</em></strong>|<strong>CSS2</strong>] [<strong><em>IE4B1</em></strong>|<strong><em>N4B3</em></strong>|<strong>O3.5</strong>]<br />
</td>
<td colspan="2" style="text-align: center;"><strong>Other Border-Style Properties</strong><br />
</td>
</tr>
<tr>
<td style="text-align: center;"><a href="btstyle.htm">border-top-style</a><br />
...
**Syntax**  
**Selector** { <span class="property">border-style:</span> \[**style**\] **{1,4}** }
...
Ext/Doc: **strong** { <span class="property">border-style:</span> groove inset solid none }

</div>

<div class="example">

In-Line:  \<**strong** <span class="tagattrib">STYLE</span>="<span class="property">border-style:</span> dotted"\>this is a beautiful test\</**strong**\>
