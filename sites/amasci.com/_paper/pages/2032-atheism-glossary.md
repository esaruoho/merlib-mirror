---
title: "#atheism Glossary"
source_domain: amasci.com
source_path: ~cwj2/atheism/athgloss.html
order: 2032
...
*Source page: `~cwj2/atheism/athgloss.html`*

# The \#Atheism Glossary

<span class="small">Last updated 7 January 1999</span>

<img src="../images/redline.gif" data-align="TOP" width="456" height="9" alt="------------------" />
...
Since this is an \#atheism community project, I would very much appreciate it if you [contacted me](mailto:cwj2@eskimo.com) if you have any ideas for revisions or if you wish to submit full definitions. This glossary is not very complete right now, as you can see, and it will never be truly fully complete, so you may want to check back here from time to time.

<img src="../images/redline.gif" data-align="TOP" width="456" height="9" alt="------------------" />

<img src="../images/shiny.gif" data-align="LEFT" width="30" height="16" alt="*" /><span id="agnosticism">Agnosticism</span>, n. -  
Agnosticism is the epistemological position that one cannot ever know positively whether or not supernatural phenomena, especially gods, exist. This was the original definition when the term was coined by Thomas Huxley in 1876, and is the most "correct" definition. Note that since this says nothing as to whether or not gods actually exist, it is possible to be both an agnostic and an atheist, or an agnostic and a [fideist](#fideism) theist. Most people who identify themselves as "agnostics" are "weak" [atheists](#atheism). Although Huxley himself mistakenly claimed that agnosticism was a third, distinct option between the alleged certainty of theism and the alleged certainty of atheism, Huxleyian agnosticism should *not* be confused with being undecided as to whether or not gods actually exist (which would be a form of "weak" atheism); one can easily be undecided and still believe that he *can* know.
...
<img src="../images/shiny.gif" data-align="LEFT" width="30" height="16" alt="*" /><span id="atheism">Atheism</span>, n. -  
...
<img src="../images/shiny.gif" data-align="LEFT" width="30" height="16" alt="*" /><span id="christian">Christian</span>, n. -  
...
<img src="../images/shiny.gif" data-align="LEFT" width="30" height="16" alt="*" /><span id="deism">Deism</span>, n. -  
...
- John Toland: <u>Christianity Not Mysterious</u>
- Thomas Paine: <u>The Age of Reason</u>

<img src="../images/shiny.gif" data-align="LEFT" width="30" height="16" alt="*" /><span id="evolution">Evolution</span>, n. -  
...
- Darwin, Charles: <u>On the Origin of Species</u>
- Dawkins, Richard: <u>The Blind Watchmaker</u>

<img src="../images/shiny.gif" data-align="LEFT" width="30" height="16" alt="*" /><span id="faith">Faith</span>, n. \[Submitted by AltKey\] -  
...
There are some assumptions implicit in the [Christian](#christian) concept of faith, though often unspoken and sometimes not realised by its advocates. Christian faith implies a god that is not observable through any of the senses in ordinary circumstances, and furthermore this god is undetectable through any of the instrumentation thus far made by humankind. This type of god of course cannot be 'proved' to exist using any scientific method of proof and must be accepted on faith. While it is true that Christians testify to an experience of god, and feel god's presence (at least this is what many Christians often claim while visiting \#atheism) it is clear that the 'evidence' that christians can adduce to support their belief in god is either ambiguous (as in the case of the [Argument from Design](design.html) etc), fallacious, or subjective and not reproducible without having faith, all of which makes many [atheists](#atheism) doubt that such a being exists at all.

<img src="../images/shiny.gif" data-align="left" width="30" height="16" alt="*" /><span id="fideism">Fideism</span>, n. -  
Fideism is the epistemological and theological position that belief in God<sup>[1](#fideism_fn1)</sup> should only be based on a "leap of [faith](#faith)." Sometimes this position is adopted in a simple confession that one cannot justify theism with [logic](#logic), but that it is justified anyway by *pragmatist* concerns (the belief makes me happy/makes me a better person/etc. so I am justified in believing it). Some fideists (especially Christian existentialists such as Kierkegaard) go so far as to say that attempts at rationalist justification dull and defeat the emotional faith experience, which they see as the essence of [Christianity](#christian).

One of the most interesting aspects of fideism is that, since it denies the need for positive knowledge of God's existence, it is actually compatible with [agnosticism](#agnosticism) in the general sense (although Huxley himself considered it *immoral* to believe in things for which there is no proof). Indeed, most fideists (including Kierkegaard once again) adopt what is essentially an agnostic theistic stance.

<sup><span id="fideism_fn1">1</span></sup> Although, strictly speaking, fideism could be applied to the justification of any god (or for that matter, any entity), it has most commonly been associated with Christianity and its God within academia.

<img src="../images/shiny.gif" data-align="LEFT" width="30" height="16" alt="*" /><span id="fundamentalism">Fundamentalism</span>, n. \[submitted by AltKey, edited by Heathen\] -  
...
<img src="../images/shiny.gif" data-align="LEFT" width="30" height="16" alt="*" />Fundie, n. -  
An abbreviation for [Fundamentalist](#fundamentalism). It is used to describe fundamentalists, zealots, and generally obnoxious rabid adherents to a particular religion, especially [Christians](#christian).

<span id="logic"><img src="../images/shiny.gif" width="30" height="16" alt="* " />Logic, n. -</span>  
Logic is the philosophical discipline of evaluating propositions for truth. This involves three primary disciplines:

1.  *Syntax*: the expression of a statement. Syntax provides a method for expressing references to objects and the relationships between them.
2.  *Semantics*: the meaning of a statement. Semantics provides a method for determining what referrants are referred to by the syntactical expression and what the relationships between them mean.
3.  *Argument*: the method of verifying or falsifying the proposed relationships between objects.
...
- "matthew": [Constructing a Logical Argument](http://www.infidels.org/news/atheism/logic.html)
- Copi, Irving M.: <u>Introduction to Logic</u>

<img src="../images/shiny.gif" data-align="LEFT" width="30" height="16" alt="*" />Philosophy, n. -  
...
- [Logic](#logic) - the branch that deals with evaluating the truth of propositions.
...
<img src="../images/shiny.gif" data-align="LEFT" width="30" height="16" alt="*" />Xian, n. -  
An abbreviation for [Christian](#christian). This comes from the Greek name for Christ, *Xristos*, and is the same notation as in Xmas. Another variation on this is Xtian. It should be noted that this is not inherently any more insulting or denigrating than the word Christian itself.

<img src="../images/shiny.gif" data-align="LEFT" width="30" height="16" alt="*" />Zarathustrianism, n. -  
...
\- [FAQ](http://www.yougogirl.com/atheism/athfaq.html) - [Ops](http://www.yougogirl.com/atheism/athops.html) - [Rules](http://www.yougogirl.com/atheism/rules.html) - [Abuses](http://www.yougogirl.com/atheism/abuses.html) - [Main](http://www.yougogirl.com/atheism/) - [Links](http://www.yougogirl.com/atheism/links.html) -

Maintained by Charles W. Johnson (<cwj2@eskimo.com>).\
