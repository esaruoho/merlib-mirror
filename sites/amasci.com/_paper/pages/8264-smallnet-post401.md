---
title: "SMALLnet post401"
source_domain: amasci.com
source_path: ~smallnet/Archive/post401.html
order: 8264
...
*Source page: `~smallnet/Archive/post401.html`*
...
A VERY IMPORTANT thing to note is that the virus is NOT, repeat: \*NOT\*, coming to you through the \< <SMALLnet-list@eskimo.com> \> e-mail list!
...
...Chris Murphy \< <chrismurphy@inet.net.nz> \> had his computer infected by a virus, which sent three spurious e-mails to SMALLnet. But my server blocked the evil content. I had my system scoured out anyway by McAfee (they provide an on-line service) and it's clean. \[JW\]

Trevor Carey \< <tc240z@bigpond.net.au> \> has some tips on this problem:
...
Mike Gillihan \< <CFIIMEI@aol.com> \> inquires:
...
Glenn Bolick \< <rgb8@juno.com> \> wrote:

Let me add my thanks to both Joe and Randy for the SMALLnet! It's a keeper!

<span id="126">Source: Batteries, Nicad, sub-C\
</span> Just ran across something that is too good to pass up if anyone needs sub-C ni-cds in 1300 mAh capacity. Harbor Freight Tools is selling a replacement 9.6V battery for their Drill Master rechargeable drill at \$3.99 per. Order number is 454943.
...
Trent Eyler \< <eyler@tulsaconnect.com> \> requests:
...
Jim Rundle \< <jrr10@cornell.edu> \> asserts:
...
Allan Leppanen \< <alepp@sympatico.ca> \> asks:
...
Michael Blott \< <mblott@san.rr.com> \> submitted:
...
Francis S. Person \< <persof@erols.com> \> wrote to JW:
...
Bruce Stough \< <sbs1@visi.com> \> inquires:
...
Steve Cheney \< <slcheney@mindspring.com> \> wrote:
...
<span id="372">Source: Wings, ACE R/C mini-foam\
</span> Available through Quantum Models (Jan. RCM, pages 108-112). These wings are not shown on their website as of my last check -- you must request them & expect to have them backordered.

\< <http://www.Quantummodels.com> \> or \< <Quantum1@core.com> \>.

Good luck -- Steve

Ron Ferrer \< <armadilo@creative-net.net> \> adds:

<span id="384">Source: Wings, ACE R/C mini-foam\
</span> In response to David Felin's query about Ace foam wings: they are indeed producing both versions, constant and tapered ones. You can get them through anyone who carries Ace/Thunder Tiger, or if all else fails, contact me! -- \< <http://www.creative-net.net/~armadilo/> \> -- as I stock them. Price is about 10 bucks.
...
Nic \< <littlepeople@space.com> \> is grateful:
