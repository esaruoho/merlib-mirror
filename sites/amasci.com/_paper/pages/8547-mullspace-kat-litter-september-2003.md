---
title: "Mullspace | Kat Litter | September, 2003"
source_domain: amasci.com
source_path: ~strange/litter/septlitter03.html
order: 8547
...
# Mullspace | Kat Litter | September, 2003

*Source page: `~strange/litter/septlitter03.html`*
...
My brother-in-law has been on a <a href="http://www.neon-buddha.net/journey/" target="blank">big adventure</a>. During the course of this, he has formulated an advancement on and practical appliction for the buttered-cat-perpetual-motion theory. Let me explain.

First restate the underlying theory: As a cat is known to land on its feet and a slice of buttered bread is known to land buttered-side down, perpetutal cyclical rotary motion should be attainable by strapping a piece of buttered bread to a cat's back, butter side out. Henceforth, this mechanism shall be known as the "buttered cat," for convenience. The buttered cat is raised above the ground and, upon release, the rotary motion begins, spontaneously, as the falling cat attempts to orient its feet toward the ground while the bread attempts to orient its buttered surface the same way. As neither can prevail without the failure of the other, the buttered cat will spin around its spinal axis perpetually, or until stopped by some outside force, like the removal of the butter or collision with the ground as gravity rules supreme.

Genesis of the New Theory: Chris, while riding the motorcycle from Alaska to Washington state, posited that a buttered cat would spin more furiously as the cat was closer to the ground and collision became imminent. Failure to land feet up would become an event to be frantically avoided, while, at the same time, the bread would be increasingly determined to land butter-side down and thus fulfill its own law, as well. So, if the buttered cat could be coupled to a drive shaft and the accelerator to a rod which pushed the buttered cat (or cats, but we'll get to that in a moment) closer to the ground, you could have a remarkably efficient engine which accelerates whenever you push on the pussy (stop snickering, you perverts....)

Now, a one-cat engine would be somewhat like a one-cylinder engine, in that it would tend to burble and have flat-spots in the performance and there is always a possibility that the cat/bread mechanism might become misaligned and allow the cat to come to rest on its side, from which position only a complete overhaul of the butter-assembly will re-start the device. To avoid this, Chris has proposed a multi-cat engine: the inline three-tabby.

The inline three-tabby would have three buttered cats inline along the drive shaft, rotated 120-degrees from each other. This ensures that a piece of buttered bread or un-buttered cat feet would always be rising toward top dead center or falling toward the ground at any given moment, thus forcing the rotary motion advanced in theory to be perpetuated with minimum re-alignement of buttered bread in practice.

The triple-cat alignment could be enlarged for trucks or heavy vehicles--though a larger cat would be required. Ther is, of course, also the possibility for longer-shaft engines, such as the inline six-puma and the V-12-cougar (thus saving a once-fine car-brand from extinction). Maintenance and fueling would be accomplished at already-existing Stop-n-Shop types of establishments by letting the kitties out of the engine compartment for a good scratch around while the driver popped inside the shop for ten pounds of raw meat and a pound of butter to refresh the bread (centrifugal force is still an issue, as bits of butter would be flung from the bread periodically as it spun around on the cats' backs). Large-cat engines might be a bit more difficult to work on, as the attaching of adequate buttered bread to Bengal tigers or Saharan lions may be a bit tricky, but this is a minor quibble, when balanced against the advertising boon of being able to re-use the old Esso/Exxon slogan: "Put a tiger in your tank."

Eventually, multi-cat engines would be commonplace for everything from urban runabouts to luxury cars, putting a whole new spin on products from Jaguar Motor Corporation.

Our own cat has been observing us with some bemusement at the mention of the buttered-cat engine. I suspect that he is taking notes for reportage to the Universal Cat Apparatus which shall, no doubt, raise various legal barriers if they can. Just wait until they hear our plans for the dog-turbo option....
