...
source_path: ~scs/C-faq/q18.9.html
order: 7737
...
*Source page: `~scs/C-faq/q18.9.html`*
...
Vinit Carpenter maintains a list of resources for learning C and C++; it is posted to comp.lang.c and comp.lang.c++, and archived where this FAQ list is (see question [20.40](q20.40.html)), or on the web at <http://vinny.csd.mu.edu/learn.html> .

See also question [18.10](q18.10.html).

------------------------------------------------------------------------

Read sequentially: <a href="q18.8.html" rev="precedes">prev</a> <a href="q18.10.html" rel="precedes">next</a> <a href="s18.html" rev="subdocument">up</a> [top](faq.html)
