---
title: "HOME-ED Homeschooling forum (email list)"
source_domain: amasci.com
source_path: homesch/homlst.html
order: 550
...
# HOME-ED Homeschooling forum (email list)

*Source page: `homesch/homlst.html`*
...
<tbody>
<tr>
<td><a href="http://amasci.com/">HOME SCHOOL SCIENCE</a><br />
</td>
...
# HOME SCHOOLING E-MAIL DISCUSSION LIST

# Homeschooling discussions: Email "lists"

Updated May,1999

### Links

- [HOME-ED Welcome](http://www.madrone.com/Home-ed/hewelcome.html)
- [Karen’s mailing list page](http://www.pipeline.com/~wdkmg/Karen/Lists.htm)
- [Jon’s homeschooling page: mailing lists](http://www.midnightbeach.com/hs/Talk.mail.html)
  - 

    ------------------------------------------------------------------------

    Home-ed is an [e-mail discussion group](http://www.amasci.com/lists.txt) with lots of traffic and lots of homeschoolers.\

    Home-ed website: <http://www.madrone.com/Home-ed/hewelcome.html>

        You can subscribe to the email listserve HOME-ED by sending this: 
           subscribe home-ed youremailaddrhere. 
        Send it to: majordomo@world.std.com  

        To turn off the listserve, send this:
           unsubscribe home-ed
        Send it to majordomo@world.std.com

        To get the "info" file, send this:
           info home-ed
        Send it to majordomo@world.std.com

        To send messages to all the members of the list, send them to:  
        ...
        *******************
        ...
        email to home-ed@world.std.com.

        To subscribe to home-ed, send email to home-ed-request@world.std.com
        with the following command in the body of the message:
        subscribe

        To unsubscribe from home-ed, send email to home-ed-request@world.std.com
        with the following command in the body of the message:
        unsubscribe

        To subscribe to the abridged home-ed digest (edited for direct relevance
        to home education), send email to dm@world.std.com with the following
        command in the body of the message:
        subscribe abridged home-ed-digest

        To unsubscribe from the abridged home-ed digest, send email to
        dm@world.std.com with the following command in the body of the message:
        unsubscribe abridged home-ed-digest

        To subscribe to the unabridged home-ed digest, send email to
        dm@world.std.com with the following command in the body of the message:
        subscribe unabridged home-ed-digest

        To unsubscribe from the unabridged home-ed digest, send email to
        dm@world.std.com with the following command in the body of the message:
        ...
        ****************
        ...
        that this has happened, send mail to dm@world.std.com to find out if
        you are still subscribed to the list.

        The home-ed list digests are copyright (c) 1997 by David Mankins
        (dm@world.std.com). The authors of the messages submitted to
        ...
        ********************
        ...
        COMMENTS?
        *********
        Send comments about the home-ed list to David Mankins (dm@world.std.com).

        Send comments about this welcome message to Heather Madrone
        (heather@madrone.com)

**LIKE THIS ARTICLE? WHY NOT\
[SUPPORT AMASCI.COM](http://amasci.com/tipjar.html)\**

\

[http://amasci.com/homesch/homlst.html](http://amasci.com/homesch/homlst.html.html)\
Created and maintained by [Bill Beaty](http://amasci.com/billb.html). Mail me at: [<img src="http://amasci.com/graphics/abc.gif" data-border="0" width="141" height="19" />](http://amasci.com/amafrm/).\
