---
title: "Old website: Seattle Outsider Artist Project"
source_domain: amasci.com
source_path: soap/index.html
order: 197
...
# Old website: Seattle Outsider Artist Project

*Source page: `soap/index.html`*
...
[S.O.A.P Home Page](http://seattleoutsider.org/soap) (new 2006)\

### LINKS

- [Official S.O.A.P. website](http://soap.inability.org/) (new 2006!)
- [Outsider Artist e-mail list](http://seattleoutsider.org/mailman/listinfo/seattleoutsiders_seattleoutsider.org) (inability.org)
- Yahoo [S.O.A.P.](http://groups.yahoo.com/group/SeattleSoap/) forum
- Topica [S.O.A.P Forum](http://lists.topica.com/lists/seattleoutsiders/)
- Topica [Weird Genius](http://lists.topica.com/lists/WeirdGenius/read) forum
- [seattlesoap.org](http://www.seattlesoap.org/) (dead?)
- Vaguely similar group: [Seattle Cacophony](http://groups.yahoo.com/group/seattlecacophony/)

### EVENTS

- May 2006 ["Bring Your Own Art" Exhibition](http://www.seattleoutsider.org/soap/what-we-do.html)
- July 2005 [Weird Genius Real Science II](http://amasci.com/weird2.html)
- April 2004 [WEIRD GENIUS REAL SCIENCE](http://www.inability.org/juicybrain.html) adult science fair , see [e-vite](http://www.evite.com/pub/weirdgenius/realscience) and [topica forum](http://lists.topica.com/lists/WeirdGenius/read)
- Oct 2003 [Indy Horror Flicks](http://lists.indymedia.org/pipermail/imc-seattle/2003-October/004341.html)
- Nov 2003 [Internet Movie/Flash Night](http://lists.indymedia.org/mailman/public/seattle-editorial/2003-November/004309.html)

<!-- -->

## THUMBNAIL OF SEATTLE OUTSIDER ARTISTS PROJECT

\

The Seattle Outsider Artists Project (SOAP) is a Washington State non-profit dedicated to supporting creative individuals and groups that cannot or will not get resources from conventional sources or exposure in conventional venues. Like the Indymedia Center (IMC), it is the goal of SOAP to further the self-determination of marginalized and under-represented people by providing them with the tools and resources to become personally involved in media production, though our sphere of concern is creative expression rather than journalism. We are working to provide alternatives to "mainstream" modes of art production and consumption that rely heavily on a dwindling state support apparatus, on foundations and institutions which reward insular elites over promising amateurs and "outsiders", or on corporate sponsorship, which is subject to the biases and narrow worldview typical of corporate controlled media.\
...
<http://amasci.com/soap/index.html>\
Created and maintained by [Bill Beaty](http://amasci.com/billb.html). Mail me at: [<img src="http://amasci.com/graphics/email.gif" data-border="0" width="141" height="19" />](http://amasci.com/amateur/amform.html#urls).\
