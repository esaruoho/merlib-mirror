---
title: "Pick a boat, any boat"
source_domain: amasci.com
source_path: ~warlock/boat/criteria.html
order: 9567
...
*Source page: `~warlock/boat/criteria.html`*

# Criteria, or

\

## "How to pick a boat when you are not sure what you want"

(Note, this is now obsolete as we now have a boat, see [here](windwalker.html) )
...
We have looked at a bunch of boats so far, and some fit the criteria, even though we haven't seen the right example yet. Here's some of the ones we are considering. In no particular [order](possibles.html)
