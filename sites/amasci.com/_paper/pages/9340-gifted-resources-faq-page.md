---
title: "Gifted Resources FAQ Page"
source_domain: amasci.com
source_path: ~user/zfaq.html
order: 9340
...
# Gifted Resources FAQ Page

*Source page: `~user/zfaq.html`*

# FAQ Files

These are files with answers to Frequently Asked Questions. These FAQ files come from a variety of sources which may be of interest.

## Gifted Resources FAQ

None known.

## Other FAQ files

- [misc.kids FAQ](ftp://rtfm.mit.edu/pub/usenet/news.answers/misc-kids/faq) - this is the complete with instructions for retreiving each FAQ file. Many of the FAQ files are only available by email.
- [some misc.kids FAQs by FTP](ftp://rtfm.mit.edu/pub/usenet/news.answers/misc-kids/)
- [some misc.kids FAQs by WWW](http://www.internet-is.com/misckids/.html)
- [Usenet FAQ archives (for all topics)](http://www.cis.ohio-state.edu/hypertext/faq/usenet/)
