...
source_path: ~fritzsch/game/faq.operations.html
order: 3210
...
*Source page: `~fritzsch/game/faq.operations.html`*
...
The Ps 203,000 for new-line training in Sereno must translate to about \$8,000 with an exchange rate around Ps 25 to \$1. <span id="O2"></span>
...
The box on page 68 of the Player's Manual is correct. Even though you may substitute new model production for old model orders, the effect of the new model on demand will not be apparent until it officially goes on sale at the beginning of the next quarter. <span id="O3"></span>
...
Deactivation takes effect immediately. If you don't need the lines for only a couple of quarters, you might find it less expensive to try "layoff" rather than deactivation. <span id="O7"></span>
...
It is not possible to transfer second-shift production employees to the first shift, though that may be a good idea for future versions of the simulation. <span id="O8"></span>
...
As an aside you can raise some interesting questions about the impact that has upon US workers and what responsibility the firm has to its work force. Many interesting avenues of discussion can be followed from this. <span id="O10"></span>
...
Second-shift operations are not available in Sereno. <span id="O11"></span>
...
Please see the Player's Manual, page 68, for additional details. <span id="O12"></span>
...
Allowing a little bit for inflation, the numbers would come out about right on this assumption. The figures given for training new employees is for Year 3, Quarter 1. As you go through the game, the amounts will increase according to changes in the CPI.
