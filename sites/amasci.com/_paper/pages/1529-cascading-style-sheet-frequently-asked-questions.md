---
title: "Cascading Style Sheet Frequently Asked Questions"
source_domain: amasci.com
source_path: ~bloo/indexdot/css/topics/stylefaq.htm
order: 1529
...
*Source page: `~bloo/indexdot/css/topics/stylefaq.htm`*

<span class="pagetitle">Cascading Style Sheets FAQ</span>\
...
1.  [What are Cascading Style Sheets?](#one)
2.  [Why do style sheets exist?](#two)
3.  [Why use style sheets?](#three)
4.  [Who defines the CSS standard? Is it one person? A company?](#four)
5.  [What can be done with style sheets that can not be accomplished with regular HTML?](#five)
6.  [Is there anything that *CAN'T* be replaced by style sheets?](#six)
7.  [How do I design for backward compatibility using style sheets?](#seven)
8.  [What browsers support style sheets? To what extent?](#eight)
9.  [Do any WYSIWYG editors support creation of CSS? Any text editors?](#nine)
10. [Can you use someone's style sheet without permission?](#ten)
11. [What does the "Cascading" in "Cascading Style Sheets" mean?](#eleven)
12. [Which style specification method should be used? Why?](#twelve)
13. [What are the advantages and disadvantages of the various style specification methods?](#thirteen)
14. [As a reader, how can I make my browser recognize my own style sheet?](#fourteen)
15. [How do you override the underlining of hyperlinks?](#fifteen)
...
\
It is not a great idea to reference an external style sheet on someone else's server. Doing this is like referencing an in-line image from someone else's server in your HTML document. This can end up overloading a server if too many pages all over the net reference the same item. It can't hurt to contact the author of a style sheet, if known, to discuss using the style sheet, but this may not be possible. In any case, a local copy should be created and used instead of referencing a remote copy. <span id="eleven"></span>
...
For more information, see the section on cascading in the [CSS1 Specification](http://www.w3.org/TR/REC-CSS1#the-cascade) or the [Index DOT Css](../index.html) section on the Style Sheet [Cascade](cascade.htm) process. <span id="twelve"></span>
...
\
If you are planning on using more than one style specification method in your document, you must also worry about Cascading Order of Style methods (see [question 11](#eleven).) If you are going to use only one method, then some guidelines about the nature of each method need to be kept in mind. The answer to this question is also very much related to the advantages and disadvantages to using each of them ([next question](#thirteen).)

\
**Method 1:** [External Style Sheets](../syntax/inclusion/external.htm) (The [LINK](http://www.blooberry.com/indexdot/html/tagpages/l/link.htm) <span class="external">\[--\>Index DOT Html\]</span> element)  
...
**Method 2:** [Embedded](../syntax/inclusion/embedded.htm) Style Sheets (The [Style](http://www.blooberry.com/indexdot/html/tagpages/s/style.htm) <span class="external">\[--\>Index DOT Html\]</span> element)  
...
**Method 3:** [Inline](../syntax/inclusion/inline.htm) Styles (STYLE attribute to HTML elements)  
If you only have to apply style to one or a few elements in a single document, your best bet will often be an Inline Style. This method attaches a style definition within the HTML element it is modifying. <span id="thirteen"></span>

\
**13. What are the advantages/disadvantages of the various style methods?**\
Each method of specifying style information has something going for it (else it would not exist), but each method also has drawbacks as well. This question is very closely related to the [previous question](#twelve). These factors should be considered when planning your use of Style Sheets.\
\
...
   **A** { <span class="property">text-decoration:</span> none }\
and within an anchor element as:\
   \<**a** <span class="tagattrib">HREF</span>="example.htm" <span class="tagattrib">STYLE</span>="<span class="property">text-decoration:</span> none"\>link text\</**a**\>\
\
