---
title: "Vortex Point Experiments"
source_domain: amasci.com
source_path: freenrg/pyrexp1.html
order: 405
...
*Source page: `freenrg/pyrexp1.html`*
...
- [Background Information](http://amasci.com/freenrg/pyrexp1.html#back)
- [The Experiment](http://amasci.com/freenrg/pyrexp1.html#exp)
- [Current Events](http://amasci.com/freenrg/pyrexp1.html#cur)
...
My friend L has continued with experiments at the "points" but without the amplification of the pyramid. The points can be detected with a resistor, much as Kozyrev used in his time experiments. The effect is greatest 2 days after the full moon. It is most intense at 12 noon each day. Jean-louis's [Time Shift Detector](http://www.geocities.com/ResearchTriangle/Facility/7014/html/tsd.htm) shows that the effects can also be detected by using two separated, stable quartz oscillators beating against each other. This experiment was done without taking account of the location of any "special points" in the area of his lab. Locating his "point" is the next order of business.
...
This page © 1999 by [Fred Epps](mailto:fepps@halcyon.com).
