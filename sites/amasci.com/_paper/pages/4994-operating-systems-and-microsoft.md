---
title: "Operating Systems and Microsoft"
source_domain: amasci.com
source_path: ~mighetto/lsopsys.htm
order: 4994
...
*Source page: `~mighetto/lsopsys.htm`*

# Operating Systems and Microsoft

------------------------------------------------------------------------

[<img src="osscale.jpg" data-align="left" width="180" height="124" />](lsmonop.htm)Since the 1960's operating systems have been defined as the software that controls the hardware. Hardware provides the raw computing power and operating systems make this power conveniently available to users.
...
From the above, browser software would not appear to fit within an operating system because it does not primarily manage computer hardware. A preliminary injunction issued on December 11 1997, by U.S. District Judge Thomas Penfield Jackson barred Microsoft from requiring computer makers to install its Internet Explorer browser as a condition for licensing operating system software "including Windows 95 or any successor version thereof."

The [Seattle Post-Intelligencer](http://www.seattletimes.com/extra/browse/html97/micr_121297.html) in a page one article the next day pointed out that "Jackson wrote that he was denying the government's motion to find Microsoft in contempt, but that he might change his mind based the report of the special master. In fact, he wrote that he 'is preliminarily inclined to agree' with the government that the consent decree bars Microsoft from packaging Windows with Internet Explorer, and he wrote that "the government appears to have a substantial likelihood of success' in the final court case."
...
![](dotanim.gif) [Microsoft seeks Justice Department definition of consent-decree language](http://www.infoworld.com/cgi-bin/displayStory.pl?98019.wconsent.htm)

![](dotanim.gif) [Microsoft trys to make distiction between Operating Systems on PCs and Servers](http://www.zdnet.com/eweek/stories/general/0,11011,2645026,00.html)
...
Because Microsoft stock is widely held and its products are widely used, the need for a quality decision is great. There is sufficient information to make a high quality decision in the court record. But there are also a great many shareholders and other Microsoft supporters including politicians, who may object to and make ineffective any remedy.

Members of the Appeals court cannot be trusted to make a high quality decision given their [prior dealings](http://news.cnet.com/news/0-1003-201-324886-0.html) with Judge Thomas Penfield Jackson (who now orders a Microsoft break up), because three of the members admit to conflicts of interest, and because the remaining members have taken extraordinary steps to bypass normal procedure. At this point in time Members of the Appeals court are likely to band together and come up with decisions that lesson the damage done when it created an appearance of impropriety by agreeing to consider Microsoft's motion for a stay of breakup related maters before it had clear jurisdiction, and indeed before it could have reasonably drafted an agreement. The timing of the agreement created the appearance that Microsoft lawyers either coached the Appeals court or drafted the court document.
