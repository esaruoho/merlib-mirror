---
title: "M*A*S*H FAQ: Character List"
source_domain: amasci.com
source_path: ~bpentium/marcia/mashchar.html
order: 1684
...
# M*A*S*H FAQ: Character List

*Source page: `~bpentium/marcia/mashchar.html`*

# M\*A\*S\*H FAQ: Character List

Posted by Doug Krause\
...
------------------------------------------------------------------------
    ...
    Thanks to:
      ...
      TDEDWA01@ulkyvx.louisville.edu
      Michael Donnelly <donnellm@oasys.dt.navy.mil>
      Scott Bilder <bilder@gandalf.rutgers.edu>
      Vic Kamhi <kamhiv@pt.cyanamid.com>
      BOWES  K <E2W4@UNB.CA>
      Christopher Taloff <cptaloff@ucdavis.edu>
    ...
    ftp://rtfm.mit.edu/pub/usenet/news.answers/tv/mash/characters
    ftp://ftp.uu.net/usenet/news.answers/tv/mash/characters.Z
    http://www.cis.ohio-state.edu/hypertext/faq/usenet/tv/mash/characters/faq.html

    Please send any corrections or new information to dijon@best.com.

    -- 
    Doug Krause   dijon@best.com         http://www.best.com/~dijon/
    "Now the circle is complete.  The Circle of Life!" -Mufasa Vader
