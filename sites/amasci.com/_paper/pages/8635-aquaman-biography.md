---
title: "Aquaman Biography"
source_domain: amasci.com
source_path: ~tegan/aqua/bios/aquaman.html
order: 8635
...
*Source page: `~tegan/aqua/bios/aquaman.html`*
...
- **Hero**: Aquaman
- **Real Name**: Orin
- **Also Known As**: Arthur Curry
- **Dual Identity**: Publicly known
- **Occupation(s)**: Protector of the Seas and Oceans, King of Poseidonis
- **Place of Birth**: Atlantis, DC-Earth
- **Marital Status**: Divorced
- **Usual Base of Operations**: The City of Poseidonis (also has refuge commonly known as the Aquacave)
...
- **Hair**: Blond
- **Superhuman Powers**:\
  - Ability to communicate directly with sea life
  - Ability to sense the primal emotions of aquatic creatures through "The Clear"
  - Heavy-Duty telepathy allows him to control any aquatic creatures
  - Sonar power which allows him to detect things when blinded
  - Can swim underwater at rates up to 100 mph
  - Can withstand extremes of temperature and pressure
- **Source of Powers**: Son of wizard and Atlantean queen, "gift" of Poseidon (sea god)
- **Special Skills**: Excels at Hand-to-hand combat, has natural leadership qualities.
- **Weapons**: Hook (created by S.T.A.R. labs) that has replaced his left hand is able to shoot a thin cord to ensnare an enemy or can be used as a rope for climbing or swinging. Hook is also able to drill through objects. He controls the hook cybernetically. Hook can be retracted into its housing, and covered with fake hand.
- **Known Limitations**: Cannot be out of the water for extended periods (pre-Crisis the limit was one hour, now the limit is uncertain).
- **Known Relatives**: Atlanna (Mother, deceased), Atlan (Father, deceased), Orm (Ocean Master, half-brother), Arthur Junior (son, deceased), AJ (son, living in another dimension), Mera (former wife), Koryak (son, exiled from Atlantis)
- **Known Allies**: Tempest (aka Aqualad, Garth), Dolphin, Deep Blue, Tsunami, Power Girl
...
The current incarnation of Aquaman is written by Erik Larsen. As far as I know, this Aquaman bio tells only information that is in continuity:
...
1.  
2.  Original origin - son of a scientist whose skills allowed him to create an 'amphibian' child (as related in More Fun \#73). Has no superpowers beyond the ability to survive underwater.
3.  Tom Curry, the lighthouse keeper, as his father and Atlanna, the mermaid, as his mother. The version we all know and love, first related in Adventure \#260 (1st Silver Age appearance).
4.  Atlanna, Queen of Atlantis, as his mother, with unspecified father (in the Giffen/Swan miniseries).
5.  Atlanna, Queen of Poseidonis, as his mother and Atlan the Wizard as his father (Atlantis Chronicles and current origin).
...
- More Fun comics \#73 (1941) First Appearance ever!
- More Fun \#73-107
- Adventure Comics \#103-259

### Silver Age

- Adventure \#260 (First Silver Appearance)
- Adventure \#260-280
- Showcase \#30-33 (1961)
- Detective Comics \#293-300
- Aquaman \#1-56 (1962)
- Brave and the Bold \#73, 82, 126
- Action Comics (in rotation w/Atom and Air Wave) \#517-521, 527-531, 536-541
- Adventure Comics \#435-437, 441-452, 460-466, 475-478
- Aquaman \#57-63 (1977)
- Brave and the Bold \#142 (Aug 1978)

### Modern Age

- 4 issue mini-series (1986) Blue costume
- 1988 Special (Aquaman: Spirit and Flesh)
- The Legend of Aquaman (1989 special)
- 5 issue mini-series (1989) Giffen series
- Atlantis Chronicles (7 issue mini-series) *Background to Peter David's series*
- Aquaman \#1-13 (1991)
- Time and Tide (4 issue mini-series) *Now a trade paperback*
- Aquaman \#1-2, 0, 3-current
