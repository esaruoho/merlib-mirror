...
source_path: ~jet/nutrition/Poultry Products.html
order: 3806
reachable_from_entry: false
images: 0
internal_links: 0
extracted: 2026-08-07T17:10:30Z
extractor: site_to_paper.py (pandoc)
---

# Poultry Products

*Source page: `~jet/nutrition/Poultry Products.html`*
...
container (cooked, yield from 400g raw liver)
...
breast, bone removed (yield from 1 lb ready-to-cook chicken)
...
drumstick bone and skin removed (yield from 1 lb ready-to-cook chicken)
...
drumstick, bone and skin removed
...
leg, bone removed (yield from 1 lb ready-to-cook chicken)
...
leg bone and skin removed (yield from 1 lb ready-to-cook chicken)
...
thigh, bone removed (yield from 1 lb ready-to-cook chicken)
...
thigh, bone and skin removed (yield from 1 lb ready-to-cook chicken)
...
wing, bone removed (yield from 1 lb ready-to-cook chicken)
...
wing, bone and skin removed (yield from 1 lb ready-to-cook chicken)
...
unit (yield from 1 lb ready-to cook capon)
...
unit (yield from 1 lb ready-to-cook goose)
...
unit (yield from 1 lb ready-to-cook guinea)
...
unit (yield from 1 lb ready-to-eat pheasant)
...
unit (yield from 1 lb ready-to cook quail)
...
unit (yield rom 1 lb ready-to-cook squab)
...
medium slice (approx 3" x 2" x 1/4")
...
thick slice (approx 3" x 2" x 3/8")
...
patty (4 oz, raw) (yield after cooking)
...
patty (yield from 135.8 g raw meat)
...
full rump cooked ( yield from 695 g raw meat )
...
inside drum cooked ( yield from 572 g raw meat )
...
patty ( yield from 108.8 g raw meat )
...
container (cooked, yield from 388g raw liver)
...
Turkey, light or dark meat, smoked, cooked, skin, bone removed
