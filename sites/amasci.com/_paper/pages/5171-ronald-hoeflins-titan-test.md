---
title: "Ronald Hoeflin's Titan Test"
source_domain: amasci.com
source_path: ~miyaguch/titan.html
order: 5171
...
*Source page: `~miyaguch/titan.html`*

**The Titan Test**

Even harder than the [Mega](http://www.eskimo.com/~miyaguch/mega.html)!
...
Send questions/comments related to this Web page to [Darryl Miyaguchi](mailto:miyaguch%20at%20eskimo%20dot%20com)
...
| 12/27/97 | Problem 33 again (my bad). The wording of the addendum should read, "Each of the Mbius strips..." rather than "The Mbius strip..." |
...
1\. ANSWER SHEET. Please print out the [answer sheet](http://www.eskimo.com/~miyaguch/t_answ.html) and write your answers there. Provide the other information requested too.
...
8\. SOCIETY ADMISSIONS USAGE: This test is accepted as an admissions test by the [Top One Percent Society](http://www.eskimo.com/~miyaguch/tops.html) (minimum: 10 right), the [One-in-a-Thousand Society](http://www.eskimo.com/~miyaguch/oath.html) (24 right), the [IQuadrivium Society](http://www.e-z.net/~karyn/hi-iq/hi-iq.html) (24 right), the [Glia Society](http://members.chello.nl/p.cooijmans/glia.htm/gliasociety/) (24 right), the [Prometheus Society](http://www.prometheussociety.org/) (36 right, obtained before April 25, 1999), and the [Mega Society](http://www.MegaSociety.org/) (43 right, obtained prior to 1995).
...
24. SWEET*NESS* : SUFFIX :: BOAT*SWAIN* : ?
...
<tbody>
<tr>
<td colspan="2" width="60%">The design to the right is made up of three squares of different sizes, lying one on top of another. What is the minimum number of squares that would be sufficient to create each of the following patterns?</td>
<td width="40%"><img src="http://www.eskimo.com/~miyaguch/hoeflin/example.gif" width="179" height="171" /></td>
</tr>
</tbody>
</table>
...
|  |  |
|----|----|
| 25\. | <img src="http://www.eskimo.com/~miyaguch/hoeflin/no25.gif" width="179" height="171" />\[cf. Hoeflin Power Test, [problem 2](http://www.eskimo.com/~miyaguch/power.html#power2)\] |

<table data-border="0" width="100%">
<tbody>
<tr>
<td width="5%">26.</td>
<td colspan="2" width="95%"><img src="http://www.eskimo.com/~miyaguch/hoeflin/no26.gif" width="211" height="195" /></td>
</tr>
</tbody>
</table>
...
|  |  |
|----|----|
| 27\. | <img src="http://www.eskimo.com/~miyaguch/hoeflin/no27.gif" width="211" height="211" /> |

<table data-border="0" width="100%">
<tbody>
<tr>
<td data-valign="top" width="5%">28.</td>
<td colspan="2" width="95%">If each side of a tetrahedron is an equilateral triangle painted white or black, five distinct patterns are possible: all sides white, all black, just one side white, just one black, and two sides white and two black. If each side of an octahedron is a white or black equilateral triangle, how many distinct patterns are possible? [cf. Hoeflin Power Test, <a href="http://www.eskimo.com/~miyaguch/power.html#power7">problem 7</a>]</td>
</tr>
</tbody>
</table>
...
|  |  |  |
|----|----|----|
| 29\. | Suppose 27 identical cubes are glued together to form a cubical stack as illustrated to the right. If one of the small cubes is omitted, four distinct shapes are possible; one in which the omitted cube is at a corner of the stack, one in which it is at the middle of an edge of the stack, one in which it is at the middle of a side of the stack, and one in which it is at the core of the stack. If two of the small cubes are omitted rather than just one, how many distinct shapes are possible? \[cf. Hoeflin Power Test, [problem 19](http://www.eskimo.com/~miyaguch/power.html#power19)\] | <img src="http://www.eskimo.com/~miyaguch/hoeflin/no29.gif" width="163" height="155" /> |

|  |  |  |
|----|----|----|
| 30\. | Suppose a diagonal is drawn across each side of a cube from one corner to the other (see illustration to the right). How many distinct patterns are possible, considering all possible orientations of the diagonals, including all six sides of the cube in each pattern? \[cf. Hoeflin Power Test, [problem 29](http://www.eskimo.com/~miyaguch/power.html#power29)\] | <img src="http://www.eskimo.com/~miyaguch/hoeflin/no30.gif" width="189" height="177" /> |
...
|  |  |
|----|----|
| 31\. | A perfectly spherical onion is sliced by six perfectly straight knife strokes; the pieces thereby formed never having been moved from their original positions. What is the maximum number of pieces into which the infinitesimally thin outer skin of the onion can thus be divided? \[cf. Hoeflin Power Test, [problem 10](http://www.eskimo.com/~miyaguch/power.html#power10)\] |

|  |  |  |
|----|----|----|
| 32\. | A tetrahedral lump of clay is sliced by six perfectly straight cuts, the pieces never moving from their original positions. What is the maximum number of tetrahedral pieces that can thus be formed, counting only pieces that are not further subdivided? \[cf. Hoeflin Power Test, [problem 11](http://www.eskimo.com/~miyaguch/power.html#power11)\] | <img src="http://www.eskimo.com/~miyaguch/hoeflin/no32.gif" width="187" height="169" /> |
...
<tbody>
<tr>
<td data-valign="top" width="5%">36.</td>
<td colspan="2" width="95%">If a cube and a tetrahedron interpenetrate, what is the maximum possible number of solid pieces (i.e., completely bounded volumes not further subdivided)? [cf. Hoeflin Power Test, <a href="http://www.eskimo.com/~miyaguch/power.html#power25">problem 25</a>]</td>
</tr>
</tbody>
</table>
...
|  |  |
|----|----|
| 37\. | Suppose you are truthfully told that ten marbles were inserted into a box, all of them identical except that their colors were determined by the toss of an unbiased coin. When heads came up, a white marble was inserted, and when tails came up, a black one. You reach into the box, draw out a marble, inspect its color, then return it to the box. You shake the box to mix the marbles randomly, and then reach in and again select a marble at random. If you inspect ten marbles in succession in this manner and all turn out to be white, what is the probability to the nearest whole percent that all ten marbles in the box are white? \[cf. Hoeflin Power Test, [problem 31](http://www.eskimo.com/~miyaguch/power.html#power31)\] |
...
|  |  |
|----|----|
| 38\. | A tetrahedron \[cf. Hoeflin Power Test, [problem 21](http://www.eskimo.com/~miyaguch/power.html#power21)\] |

|  |  |
|----|----|
| 39\. | A cube \[cf. Hoeflin Power Test, [problem 22](http://www.eskimo.com/~miyaguch/power.html#power22)\] |

|  |  |
|----|----|
| 40\. | An octahedron \[cf. Hoeflin Power Test, [problem 23](http://www.eskimo.com/~miyaguch/power.html#power23)\] |

|  |  |  |
|----|----|----|
| 41\. | A dodecahedron (illustrated to the right) \[cf. Hoeflin Power Test, [problem 24](http://www.eskimo.com/~miyaguch/power.html#power24)\] | <img src="http://www.eskimo.com/~miyaguch/hoeflin/dodec.gif" width="127" height="117" /> |

|  |  |  |
|----|----|----|
| 42\. | An icosahedron (illustrated to the right) | <img src="http://www.eskimo.com/~miyaguch/hoeflin/icos.gif" width="97" height="106" /> |

 

**NUMBER SEQUENCES**

Determine the value of \_\_\_ in each of the following sequences. For example, in the sequence\
1 4 9 16 25 \_\_\_ 49 64, the value of \_\_\_ is 36.

43\. 4/10 \_\_\_/100 168/1,000 1,229/10,000 9,592/100,000 78,498/1,000,000\
44. 1 4 17 54 145 368 945 \_\_\_\
45. 0 6 21 40 5 -504 \_\_\_\
46. 2 15 1,001 215,441 \_\_\_\
47. 7 8 5 3 9 8 1 6 3 \_\_\_

|  |  |
|----|----|
| 48\. | <img src="http://www.eskimo.com/~miyaguch/hoeflin/no48.gif" width="155" height="24" /> |

This concludes the test.

Look at the [Titan Test Norming](http://www.eskimo.com/~miyaguch/titanorm.html)
