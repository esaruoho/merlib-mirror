---
title: "The Basics of Torsion Mechanics"
source_domain: amasci.com
source_path: freenrg/tors/tors24.html
order: 564
...
*Source page: `freenrg/tors/tors24.html`*
...
Shipov G.I. "Mekhanika orientiruemoi tochki i obschii printsip inertsii." //Izvestiya VUZ, seriya Fizika, 1985, \# 3. (russian)

Carmeli M. //Int. J. Theor. Phys., 1986, v.25, ? 1.

Shipov G.I. "Teoriya fizicheskogo vacuuma.", Moscow, NT-Centr, 1993, 362 p. (russian)

Weitzenbock R. Invariantentheorie, Groningen: Noordhoff, 1923, p.320.

Weitzenbock R. Sitz.preuss.Akad.Wiss.phys.-math. Kl., 1924, p.466-501.

Shipov G.I. "Obscherelyativistskiye nelineinyye spinornyye uravneniya." //Izvextiya VUZ, seriya Fizika, 1977, \# 3. (russian)

Shipov G.I. "Problemy teorii elementarnykh vzaimodeistvii.", Moscow, Moscow State University ("MGU" in russian), 1979. (russian)

Shipov G.I. "Ob ispolzovanii vacuumnyh polei krucheniya dlya peremescheniya mekhanicheskikh sistem.", 1991, Moscow, CISE VENT ("MNTTs VENT" in russian), preprint \# 8, 50 p. (russian)

Tolchin V.N. "Inertsioid.", 1977, Perm, 99 p. (russian)

Kozyrev N.A. "Prichinnaya ili nesimmetrichnaya mekhanika v lineinom priblizhenii.", Pulkovo, GAO AN SSSR, 1958, 90 p. (russian)

Polyakov S.M., Polyakov O.S. "Vvedeniye v eksperimentalnuyu gravitoniku.", Moscow, Prometei, 1988, 136 p. (russian)
...
Veinik A.I. "Termodinamika realnykh protsessov.", Minsk, Nauka i tekhnika, 1991, 576 p. (russian)

Krisch A.D. "The spin of proton." //Scientific American, May, 1979.

Baryshevsky V.G., Podgoretsky M.I. "Yadernaya pretsessiya neitronov." //Zhyrnal eksperimentalnoi i teoreticheskoi fiziki, 1964, v.47, p.1050. (russian)

Valraven Yu., Silver A. "Stabilizatsiya atomarnogo vodoroda." //Uspekhi fizicheskikh nauk, 1983, v.139, \# 4, p.701. (russian)

Lhuiller C. "Transport properties in a spin-polarized gas, III." //J.Phys. (Fr.), 1983, v.44, \# 1, p.1.

Sokolov Ju.L. in: Hydrogen atom. Eds.G.F.Bassani, M.Inguscio, T.W.Hausch. Berlin, Heideiberg, 1989.

Sokolov Ju.L., Yakovlev V.P. "Izmereniye lembovskogo sdviga v atome vodoroda." //Zhurnal eksperiment.i teoret.fiziki, 1982, \# 1(7), p.15. (russian)

Pokazaniev V.G., Skrotskii G.V. "Psevdomagnetizm." //Uspekhi fizicheskikh nauk, 1979, v.129, \# 4, p.615. (russian)

Gubarev E.A., Sidorov A.N., Shipov G.I. "Fundamentalnyye modeli elementarnykh vzaimodeistvii i teoriya fizicheskogo vakuuma.", Moscow, 1992, CISE VENT, preprint \# 17, 68 p. (russian)
