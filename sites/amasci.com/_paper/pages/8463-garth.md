...
source_path: ~tegan/aqua/bios/garth.html
order: 8463
...
*Source page: `~tegan/aqua/bios/garth.html`*
...
- **Hero**: Tempest
- **Real Name**: Garth
- **Also Known As**: Aqualad
- **Dual Identity**: Known
- **Occupation(s)**: Crime Fighter
- **Place of Birth**: Shayeris
- **Marital Status**: Dating Dolphin
- **Usual Base of Operations**: City of Poseidonis
- **Group Membership(s)**: Titans
- **Height**:
- **Weight**:
- **Eyes**:
- **Hair**:
