---
title: "SMALLnet post367"
source_domain: amasci.com
source_path: ~smallnet/Archive/post367.html
order: 8228
...
*Source page: `~smallnet/Archive/post367.html`*
...
...Here we go with the final Posting of the 20th Century! Word came in a few days ago that George Aldrich just came home from an 11-day hospital stay. I sure hope he's gonna be OK now... \[JW\]
...
Bob Stought \< <RStought@aol.com> \> wrote:
...
<span id="133">Source: Drive Belts, Electric\
</span> For example, there's the Hobby Lobby Mini-Olympus belt or else the Model Airtech belt. You can order any of these through: \< http://www.newcreations-rc.com/"\> (New Creations R/C) online.
...
Francis Person \< <persof@yahoo.com> \> inquires:
...
Dave Segal \< <DDavesegal@cs.com> \> suggests:
...
Harold Pike \< <MEFLYRC@aol.com> \> has a problem:
...
John Rossetti \< <jyuma@axxent.ca> \> recalls:
...
Don Stauffer \< <stauffer@gte.net> \> submitted:
...
Carlo Godel \< <regiaero@gj.net> \> responds to Randy's remarks about "variations in wing loading" in the previous Posting:
