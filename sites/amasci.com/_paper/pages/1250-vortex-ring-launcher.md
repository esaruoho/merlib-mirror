...
source_path: ~billb/amateur/vortgen.html
order: 1250
...
*Source page: `~billb/amateur/vortgen.html`*
...
# RING-VORTEX (smoke ring) LAUNCHERS

- [SMOKE-RING ANIMATION](/wing/smring.html)
- [SMALL SMOKE-RING CANNONS](#small)
- [GIANT VORTEX CANNON](#giant)
- [COMPUTER-WAVEFORM VORTEX LAUNCHER](#cpu)
- [WEIRD IDEAS](#weirdo)
- [SCIENCE FAIR HINTS](#fair)
- [HIGH-SPEED BLIMP](#blimp)
- [LINKS](#links)
...
<img src="/wing/smrg4.gif" width="160" height="160" />\

<span id="links"></span>

### Other similar sites:

- [Zero Toys](http://www.zerotoys.com) smoke-ring toy
- [Falaco Solitons](http://www22.pair.com/csdc/car/carfre3.htm), underwater half-rings
- Ned Kahn's [Fog Fountain](http://isaac.exploratorium.edu/dbarker/fogfountain.html)
- [Dolphins](http://www.bubblerings.com/bubblerings/) launch [Underwater Bubble-rings](http://earthtrust.org/delringgallery.html)
- [The SRL vortex cannon](http://home.earthlink.net/~lfod/mike/vortex.html)
- [Santa Barbara Sci](http://www.west.net/~science/acannon.htm)
- [PS-99 Vortex Cannon](http://grundmann.home.attbi.com/wrg/vger/1.html)
- [Wirbelrohr](/wirbel.txt), vortex tube acoustics
- [Suggested experiments w/ programmable vortex generator](/amateur/vort2.txt)
- [Famous WHAM-O Air Blaster](http://www.yesterdayland.com/popopedia/shows/toys/ty1114.php)
...
Heeyyyyyyy! Maybe they wouldn't need helium! If the "smoke ring" was oriented horizontally like a donut on the ground, and if the gasbags were spinning, maybe it would act like a helicopter and drive itself upwards. It would be VERY quiet, since the air flow would be almost laminar. It would look like a flying saucer. With the large surface area it would need, it may as well be helium-filled for extra lift. But with enough power, maybe helium wouldn't be necessary for flight.\
