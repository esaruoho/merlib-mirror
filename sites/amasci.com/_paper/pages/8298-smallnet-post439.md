---
title: "SMALLnet post439"
source_domain: amasci.com
source_path: ~smallnet/Archive/post439.html
order: 8298
...
*Source page: `~smallnet/Archive/post439.html`*
...
To UNsubscribe from the SMALLnet list, send an e-mail to \< 

 \> with the single word \> unsubscribe \< in the "Subject:" box of the e-mail. That will get you off the list.

Please note that this is a DIFFERENT address than used for normal list traffic. The "-request" address is only for subscribing and unsubscribing.

Also note that you MUST send this e-mail from the e-mail address under which you are subscribed. If you can no longer access that account, contact me for manual assistance.
...
Vendor: CO2, Gasparin vendor: Fritz Mueller\
