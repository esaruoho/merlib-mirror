---
title: "RAW UN-EDITED NOTES ONLY (Why Electricity is Impossible to Understand)"
source_domain: amasci.com
source_path: miscon/whyhrd3.html
order: 630
...
*Source page: `miscon/whyhrd3.html`*
...
<tbody>
<tr>
<td><strong><a href="http://amasci.com/ele-edu.html">INDEX: ELECT. ARTICLES</a>  |</strong><br />
</td>
<td><strong><a href="http://amasci.com/">AMASCI .COM</a>  |</strong><br />
</td>
...
<tr>
<td width="15"> </td>
<td data-valign="top" data-summary="main text content" width="800"><pre><code>
</code></pre>
...
<tbody>
<tr>
<td><p>BELOW are my original, very crude disorganized and totally unedited 1986-1989 notes and "raw data" collected on little scraps of paper for Electricity Exhibit, written for the Museum of Science in Boston. Some of this material became finished articles on Amasci.com.<br />
</p>
<p>Why are my explanations different than usual? Because they're not based on earlier K-12 textbooks. Instead they're based on college-level physics textbooks, but I've translated the math into English. They're also based upon the intentional defeating of misconceptions: on the painful 'unlearning' I had to go through before I could gain an intuitive understanding of simple electrical physics. I kept a running record both of textbook errors and of useful simple concepts, as well as listing my own childhood misconceptions as I discovered them.<br />
</p>
<p>[PS These notes are from before internet, before email, with many written on a typewriter and on a "word processing" system with no italics available, and most were transcribed before www and the &lt;i&gt; tag. No, the all-caps below is not shouting. This was written well before the "all caps is shouting" email standard. The all-caps in this document are actually notes to future publishers to typeset italicized words. Since apparently this opens up the material to straw-man troll attacks and accusations of angry shouting, I've added the italics tags. -billb 2015]<br />
</p>
See also:
<a href="http://amasci.com/ele-edu.html">MAIN INDEX: Articles "Electricity"</a><br />
&#10;<a href="http://amasci.com/elect/elefaq.html">Electricity FAQ: Frequently Asked Questions</a><br />
&#10;<a href="http://amasci.com/miscon/elect.html">INDEX: Electricity Misconceptions</a><br />
</td>
</tr>
</tbody>
</table></td>
...
A collection of various ideas. \[LONG!\]\
(C)1995 [William Beaty](http://amasci.com/me.html) BSEE
=======================================================

> \[Warning, THIS IS NOT A FREAKIN' ARTICLE. It's not for anyone to read. If you start "critiquing" it, better you should be giving "intelligent critique" of floor-sweepings, or random pieces of film on the cutting-room floor, but without ever bothering to watch the finished version.\]\
...
>
> In addition I began mining my own head for misunderstandings I originally had as a beginning learner. I couldn't get inside students' heads, but certainly I could get inside my own student brain of long ago. As I slowly learned new ways to understand the subject, I kept discovering new ways in which I'd *mis*understood it myself, and I kept adding to the growing pile. The misconceptions list became large, and soon I also was discovering parts of electricity that the general public invariably found misleading, or parts that were universally explained badly even in physics textbooks. (Advanced texts get the math right, but sometimes the rest of the explanation is faulty.)\
>
> Below is the result. It's my big pile of raw unedited notes. [Here's the finished product.](http://amasci.com/ele-edu.html) Someday I'll try to include all the hand-drawn diagrams as well. (The edited condensed version is here" [Bad Physics: common electricity misconceptions](http://amasci.com/miscon/elect.html).)\

## Why is 'electricity' nearly impossible to understand? Because of...

1.  [Confusing definition of "Electricity"](http://amasci.com/miscon/whyhrd3.html#def)
2.  [Mistaken assumptions](http://amasci.com/miscon/whyhrd3.html#miscon)
3.  [Electric Current](http://amasci.com/miscon/whyhrd3.html#cur)
4.  [Electric Energy](http://amasci.com/miscon/whyhrd3.html#ener)
5.  [Electrostatics](http://amasci.com/miscon/whyhrd3.html#stat)
6.  [Electric Fluid](http://amasci.com/miscon/whyhrd3.html#flu)
7.  [Electric Charge](http://amasci.com/miscon/whyhrd3.html#char)
8.  [Misc.](http://amasci.com/miscon/whyhrd3.html#misc)

<!-- -->

    SCROLL DOWN

<span id="def"></span> [UP TO: finished electricity articles](http://amasci.com/ele-edu.html)

## 1. PROBLEMS CAUSED BY THE DEFINITION OF THE WORD "ELECTRICITY"

## Why is electricity nearly impossible to understand? Because of...

...wide misuse of the word "electricity." Using Electricity as the single name for several completely different substance-like quantities, while at the same time expecting students to extract each differing meaning of the "electricity" from the way we use it in explanations. Unfortunately, students instead become permanently confused because they don't realize that the word has several conflicting definitions. They hear one word and assume we're talking about one single entity. As a result, they hear us describe a single "electricity-stuff" having contradictory, confusing, totally impossible behavior.\

...because we misuse the word "electricity." Using it to name physical entities and also classes of phenomena. Students may end up believing that static, current, electrons, and protons are various types of energy! (This is like being confused about the difference between Geology and rocks, optics versus light, or thinking that "Biology" and "living tissue" must be the same thing. But they have the same name, not light versus optics, but "electricity" versus "electricty!" )\

...we misuse "electricity" in early grades, then we never point out this earlier misuse during more advanced grades. Students end up with misconceptions learned early on. We use "lies to children" to avoid complicated explanations, but then we're never up-front with older high-school students about the misconceptions they probably acquired in grades K-6. Later info doesn't alter the misconceptions. Why can't we specifically teach kids about this problem with the definition of the word "electricity?" Let our students UN-learn the wrong stuff they'd been taught.\

...because of our ignoring the contradiction between descriptions of various "kinds" of electricity. Physics insists that there are *only* two kinds of electricity, the charges of electricity: pos and neg electricity! Then we say no, there are *only* two kinds, static and current. Then we say no, there are many kinds of electricity: it's a *class of phenomenon* with many types, like Bioelectricity, Piezoelectricity, etc. And then: no, there is *only one* kind of electromagnetic energy, and electricity is a form of energy, therefore there's only one kind of electricity. ...All these statements are both right and wrong: when used alone they are accurate only because "Electricity" has so many distinct definitions. But because these statements contradict each other, collectively they become a serious error.\
...
...because there is no electrical term analogous to "Optics" or to "Geology." Lenses and prisms are the optics, just as rocks are the geology. But a quantity of electricity ...is the electricity! What? Again:

    1. Geology versus rocks and minerals
    2. Optics versus lenses and light
    3. Electricity versus electricity.

Number three presents an enormous problem: unlike other fields of science, the "electricity" which flows through wires has the same name as the overall subject area! There is no such word as "Electrology," or "Electrics," (analogous to Geology and Optics.) This leads to horrible confusion among students, and teachers are no better off, because the K12 textbooks are filled with mistakes, for example, the two kinds of Optics are Physical Optics and Geometrical Optics, right? But we don't say that lasers send out beams of "physical optics." Yet with electricity, we do say such stupid things. We fill Leyden jars with "static electricity." Wrong, because Static Electricity isn't anything physical, instead "static" is very much like optics or geology: a topic-area only. Its more accurate name is Electrostatics. Do we fill Leyden jars with electrostatics? Do volcanoes spew out streams of Geology? Do flashlights emit beams of Geometrical Optics?\

See the problem? The two kinds of electricity are Static Electricity and Current Electricity (meaning electrostatics and electrodynamics, the two faces of Electrical Science.) No, physics says that the only two kinds of electricity are negative charges of electricity and positive. What actually flows in wires? Negative electricity, flowing at a rate of coulombs of electricity per second. At the same time, "Current Electricity" never flows, because in that case the term "electricity" means something like "electrology" or "electrics." Extremely confusing, because "current electricity" never flows, yet electric current is properly called a flow of electricity. And, we cannot measure an "amount of optics," nor can we measure an "amount of static electricity." Yet SI/MKS physics defines the Quantity of Electricity to be measured in coulombs of electricity. (One word, with two entirely different meanings ...but fortunately in other topics we have better words, Light versus Optics, Rocks versus Geology. But "Electricity versus Electricity" screws everything up, and ruins the K12 textbook explanations, making many of them wrong.\

...because we lack rigorous dedication to truth and clarity, instead there's a widespread cover-your-tail attitude where the confusing presence of multiple definitions of "electricity" in dictionaries is used to legitimize contradictory use of the word in classrooms. Rather than simply sitting down and fixing the problem in classrooms, we point to the confusion in dictionaries and insist that the classroom problem is acceptable! But just because a dictionary records the various contradictory definitions, this doesn't constitute an authoritative approval of their use by teachers.\

\

...because we use the physics-term "quantity of electricity" to legitimize other misuses of the word "electricity." Physicists use the word "electricity" in a very narrow sense, but does this mean that all *other* definitions are OK? But "quantity of electricity" means just one thing: it means charge, measured in coulombs. In other words, physicists actually say (indirectly) that it's *not* correct to believe that electricity many other things besides coulombs of charge. They're saying that electricity is *not* joules of energy, electricity is *not* the flow of electrons, or classes of phenomena, etc. They're saying that electricity means only "charge," and all other definitions are "popular" meanings, not accurate scientific ones.\

\

...because of mistaken belief that "electricity" travels one way in wires, going from source to load... and at the same time believing that electricity travels in a circle and it all returns to the source, without any being used up.\
...
...mistaken belief that "electricity" alternates: it flows equally back and forth at 60HZ, while at the same time it flows continuously forward from source to load.\
...
...wrongly assuming that students are as adept as their instructors when it comes to manipulating concepts. Some instructors know that "electricity" has multiple meanings, and therefore we must always take the word in context to see what the intended meaning is. But students don't know this, they think that since we're using a single word, we must be discussing a single concept. We end up convincing them that a single entity called "electricity" exists which has confusing, contradictory attributes.\

...textbooks start with basic assumptions about "electricity," and then expand on these. But if the basic assumptions are never critically examined, they may or may not be correct. (Example: K-6 books assume that a single substance-like entity called "electricity" exists. Another one: there are only two kinds of "electricity," not one.)\

...invisible war between old and new definitions of "electricity." The word was originally used to mean "electric fluid." As the concepts became refined, the Electric Fluid changed into "charge OF ELECTRICITY," later mutating into the term "Electric Charge," ...and eventually, simply "Charge" where a quantity of electricity was simply a quantity of Charge. But in recent decades the word has been usurped by electric companies, and now usually means "energy." But this leaves a gap, since "electric fluid", or the stuff-flowing-in-wires now has no common name. The word "charge" is often used instead, but this can be very misleading, since a wire can have zero net "charge" even while there is an enormous charge-flow within it. Even more often, the word "current" is incorrectly used instead of "electricity", as in "flow of current" (but a current is a flow. Are rivers full of current? No, water! Does "current" flow out of faucets, and buckets are full of "current?" Sheesh. "Flow of charge" is correct, "flow of current" is not.) But lots of older literature still contains the older definition of Electricity, and it states that "electricity flows inside of metals." Modern authors may unknowingly take older explanations to heart, and believe that those were discussing energy-flows, not knowing that the older works were discussing an entirely different "electricity" than is found in modern texts. A century ago, we didn't use the word Charge. Instead, scientists called it "Electricity."\

...incorrect popular conceptions of electricity which must be unlearned before accurate concepts can ever be understood.\

...mistaking the wave for the medium. Is "electricity" the electrons, or is it the wave of electron-flow, or is it energy that flows THROUGH a slow-moving column of electrons. Think of how difficult it would be to understand sound waves and air pressure if we had just a *single word* that meant both "sound" and "wind" and "air." (And it's all invisible, right? So it must be OK to say that sound is really just air? That way is much simpler to teach! Similar problem with electricity: we can say that currents *are the electricity*, as if "electricity" is a thing like wind. Then we also say that when a charge *of electricity* flows along, we call it by the name "current." Now "electricity" is a thing like air? Wrong, there are two different things here, both given the name "electricity," and we don't bother to inform students of this, because it's far simpler to do the equivalent of teaching that air is made of wind.\
...
...mistaken belief that electric current is charges flowing inside wires at the speed of light. During electric currents in metals, the charges actually flow at inches per hour.\
...
<span id="miscon"></span> [UP TO: finished electricity articles](http://amasci.com/ele-edu.html)
...
<span id="cur"></span> [^ UP ^](http://amasci.com/miscon/whyhrd3.html#top)\

OTHER ARTICLES:

- [True direction of "current"](http://amasci.com/amateur/elecdir.html)
- [Slow speed of electricity](http://amasci.com/miscon/speed.html)
- [Current versus "static"](http://amasci.com/miscon/curstat.html)
- [Current versus "charge"](http://amasci.com/miscon/curstat2.html)
- [Visible Electricity: red and green plastic](http://amasci.com/redgreen.html)
- [Are amperes fundamental?](http://amasci.com/miscon/fund.html)
- [All articles](http://amasci.com/ele-edu.html)

\

[UP TO: finished electricity articles](http://amasci.com/ele-edu.html)
...
<span id="ener"></span> [^ Up ^](http://amasci.com/miscon/whyhrd3.html#top)\
[UP TO: finished electricity articles](http://amasci.com/ele-edu.html)
...
<span id="stat"></span> [UP TO: finished electricity articles](http://amasci.com/ele-edu.html)
...
<span id="flu"></span> [UP TO: finished electricity articles](http://amasci.com/ele-edu.html)
...
<span id="char"></span> [UP TO: finished electricity articles](http://amasci.com/ele-edu.html)
...
<span id="misc"></span> [UP TO: finished electricity articles](http://amasci.com/ele-edu.html)
...
- Radio waves come out of the tip of the radio tower, like bulls-eye ripples.\
  (May be part of 1920s fight Marconi-vs-competitors, where competitors' supported ground-waves explanation, where waves issue from the base of the antenna tower.)
- Atoms always contain equal numbers of positives and negatives; one proton always has an electron, atoms can't break up (electrons never removed.)\
...
- "Electricity" is the flowing motion of electricity. "Electricity" is created whenever electricity starts flowing.\
- Energy flows out through one wire, and the other wire is empty\
- Electrons can have a voltage; have energy. No, individual electrons never carry energy along as they flow, instead the energy leaps from electron to electron, where electrons are the wave-medium and the energy is waves. Analogy with air and sound waves.\
- Voltage is the "potential do do something?" Voltage is potential energy, the energy per charge? No, voltage is "Potentials," a math term. To clarify, perhaps call it "equipotentials" rather than "potential."\
- Voltage is the energy of each electron being moved (so, no electron, no voltage?) No, voltage is the e-fields in empty space. Even when no electrons are being pushed, the "voltage hill" still exists. Voltage is like altitude above the ground, and altitude still exists even without boulders being lifted or potential energy being stored.\
...
Proceedings of The 2nd Int'l Seminar - Misconceptions and Educational Strategies in Science and Mathematics  
July 26-29, 1987. Cornell U., Ithaca NY. Vol II and III. On microfilm from ERIC Document Repro. Services. (available on internet, see above link to books)

Mario Iona, "[WHY JOHNNY CAN'T LEARN PHYSICS FROM TEXTBOOKS I HAVE KNOWN](http://ajp.aapt.org/resource/1/ajpias/v55/i4/p299_s2)"  
Millikan Award Lecture, Am J. Phys. 55 (4) Apr 1987 pp299-307

Mario Iona, WOULD YOU BELIEVE...  
Series of columns in The Physics Teacher (AAPT Publication)

Mario Iona, HOW SHOULD WE SAY IT?  
Series of columns in The Science Teacher, 1970-1972
