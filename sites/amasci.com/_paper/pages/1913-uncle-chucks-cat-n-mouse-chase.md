---
title: "Uncle Chuck's CAT-N-MOUSE Chase"
source_domain: amasci.com
source_path: ~cdickens/applets/cat-n-mouse/Chase.html
order: 1913
...
# Uncle Chuck's CAT-N-MOUSE Chase

*Source page: `~cdickens/applets/cat-n-mouse/Chase.html`*

## Uncle Chuck's CAT-N-MOUSE Chase, Version 1 and Version 2

<img src="cat-mouse-running.gif" data-align="BOTTOM" alt="IMAGE" />

------------------------------------------------------------------------

### Play Version 1

[CLICK HERE...to play version 1](chaseApplet.html)

------------------------------------------------------------------------

### Play Version 2

[CLICK HERE...to play version 2](../cat-n-mouse-v2/Chase.html)

------------------------------------------------------------------------

### Background Information on Version 1 and Version 2
...
- It IS a graphics program;
- It HAS grids with obstacles on various squares;
- It HAS balls that move from square to square.
...
- The Sokoban levels, with their all sorts of squares with and without walls, could be the chase areas.
- The balls could be limited to just two: a GRAY BALL, representing the MOUSE, and an ORANGE BALL, representing the CAT.
- The player would move the MOUSE by pressing the left-, right-, up-, and down-arrow keys.
- The computer could move the CAT.
- The CAT's moves would be determined by Uncle Chuck's very own shortest path algorithm.
- The player could handicap the CAT by selecting a mouser rating that limits the CAT's speed and smartness.
...
[To: Uncle Chuck (CLICK here)](mailto:bi186@scn.org)
