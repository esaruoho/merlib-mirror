---
title: "More Programming Information"
source_domain: amasci.com
source_path: ~htak/win32asm/hardcore.htm
order: 3479
...
*Source page: `~htak/win32asm/hardcore.htm`*

# More Programming Information

- [Program startup](#startup)
- [Subsystem version](#subsystem)
- [More on messages and threads](winmsg.htm)
- [Creating an import library from an arbitrary DLL](#importcreate)
- [Deadlock theory](hardcore.htm#deadlock)
- [Title (caption) bar and Taskbar button anomalies](#caption)
- [Documented Win32 functions that don't exist](#win32macro)
- [Obsolete Win16 functions](#oldwin16)

[Back to Win32 ASM Page](win32asm.htm)

### <span id="startup"></span>Program startup
...
### <span id="subsystem"></span>Subsystem version
...
- If previous to 4.0, standard Win32 apps will not be started by Win9x from the DOS box unless you use the START command. Console apps can always be invoked as if they were DOS commands.
- If previous to 4.0, the background colors of standard controls will be white (the old style). This is annoying when you are building dialog boxes in the new style.

### <span id="importcreate"></span>Creating an import library from an arbitrary DLL
...
### <span id="deadlock"></span>Deadlock theory
...
- **Nonpreemptive scheduling**: A resource can only be released by the process which has acquired it.
- **Partial allocation**: A process can acquire its resources piecemeal.
- **Circular waiting**: The previous conditions permit concurrent processes to acquire part of their resources and enter a state in which they wait indefinitely to acquire each other's resources.

### <span id="caption"></span>Title (caption) bar and Taskbar button anomalies
...
### <span id="win32macro"></span>Documented Win32 functions that don't exist
...
### <span id="oldwin16"></span>Obsolete Win16 functions
...
- No longer existing
  - GetModuleUsage, was mainly used to wait for other apps to end.\
    For this purpose, use CreateProcess, OpenProcess, and GetExitCode or WaitForSingleObject.
  - MoveTo, use MoveToEx
