...
source_path: ~enumclaw/fruit.html
order: 2956
...
*Source page: `~enumclaw/fruit.html`*
...
Introduction   History    Spring Tour     Other Seasons   Specimens     Herbs   Design Elements   Work   Family    Links
    ...
    Fruit as Landscaping
    (under construction)

[Vegetables](veg.html) [Berries](berries.html) as Landscaping

Back to [Specialized Gardens](Tips/Pocket%20Gardens/pocketframeset.html) Back to [Introduction](index.html)
...
<tr>
<td width="40%"><p> </p></td>
<td width="60%"><pre><code></code></pre></td>
</tr>
</tbody>
</table>

    Coming:  other old apples, peaches, pears, plums

    Berries   Vegetables  as Landscaping
