---
title: "JBM - Bibliography - Exterior Ballistics"
source_domain: amasci.com
source_path: ~jbm/bibliography/exterior.html
order: 3627
...
# JBM - Bibliography - Exterior Ballistics

*Source page: `~jbm/bibliography/exterior.html`*
...
Hatcher's Notebook,\
Julian S. Hatcher, Major General, USA, retired, Stackpole Books, Harrisburg, Pennsylvania, Second printing, 1966. -- Articles on many different subjects -- some interesting formulas. It is still in print and available directly from Stackpole.

[How do bullets fly?](http://www.povn.com/~4n6/index.htm),\
An online work by Ruprecht Nennstiel, the author of [EBV4](http://home.t-online.de/home/ruprecht.nennstiel/eb.htm). From the abstract: "This document attempts to explain the basics of the complicated subject of bullet motion through the atmosphere without using neither formulas nor mathematical derivations, but expecting familiarity with the way of physical thinking."
...
The Launch and Flight Dynamics of Symmetric Projectiles, Robert L. McCoy, [Schiffer Publishing](http://www.schifferbooks.com), Ltd., 77 Lower Valley Road, Atglen, PA 19310. (610) 593-1777. Last time I checked, it was \$95.00. **A number Bob McCoy's friends have checked the book and compiled a list of corrections. Don Miller was kind enough to compile them into a single document and provide a [copy](modeb9kc.zip) for posting here (thanks Don!). It's currently available as a Word document (zipped), but can be opened with WordPad.**
...
<span class="small">Last update 14 February 2005, Copyright © 1996-2005 [JBM](mailto:jbm@eskimo.com) [\[V\]](http://www.htmlhelp.com/cgi-bin/validate.cgi?url=referer&input=yes)</span>
