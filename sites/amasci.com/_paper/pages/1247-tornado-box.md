...
source_path: ~billb/amateur/tornbox.html
order: 1247
...
*Source page: `~billb/amateur/tornbox.html`*

[SCIENCE CLUB](http://www.halcyon.com/sciclub/) \| [SCIENCE HOBBYIST](http://www.eskimo.com/~billb/)

    TORNADO GENERATOR BOX                 (c)1996 William J. Beaty

    Doug Smith and I put together this tornado chamber as part of a
    semi-permanent science museum exhibit in Boston in 1988.  The main body
    was built from 1/4" thick plexiglas, a small 3in "boxer fan" on top of the
    case supplied the propulsion, and an ultrasonic humidifier supplied the
    white mist. 
      ...
      a more powerful fan.  R. Grummer suggests using dry ice, which can
      sometimes be had at no cost by asking your local grocery store.
    ...
    I found that the tornado is hard to see against a light background, so I
    made the two back walls opaque black, the bottom funnel and plate black,
    and two front walls transparent, then I lighted the whole thing heavily
    from the top and from slightly behind.  If I had to do it over again, I
    might try installing a flourescent tube running the length of the box. 
    This tube would need to be in the rear from the viewpoint of users, but
    with some sort of light shields added, so it illuminates the mist column
    from behind, but doesn't shine directly in the user's eyes.
    ...
    Also see HOMEMADE HURRICANE, the one from World Book that inspired me as a
    kid.  That's on Bizarre Stuff you can make in your kitchen.

    Smoke-ring Launcher, shoot ring-shaped tornadoes across the room, or
    construct a stench-gun.   Silent but deadly!

    Detailed Plans for 4-foot tornado machine

    4ft Tornado Generator (complete plans)

    Stormchaser Dave's Tornado Machine

    Tornado Simulator from Tornadoproject

    Huge man-made tornadoes from 
    Reelefx Inc
