...
source_path: teden/Tedenstig/own/partic1.htm
order: 180
...
*Source page: `teden/Tedenstig/own/partic1.htm`*
...
o
. 
We calculate this mass and the energy associated to it, using the "relativistic" formula E = m.c(2).
...
e
o
 is replaced by values from formula 10a), 13c) from our electromagnetic theory, and Ao is rewritten by use of formula 9a) from the same theory, giving: 
...
) will be in resonance with the particle's oscillation ( time period 
t
c 
) in its own electromagnetic field, times an half integer n of it. We prefer to express the equation in full integer values, introducing an correction factor k = 1+-0.06 times the number of 
p
, giving the following set of formulae :
...
B-meson, see New Scientist 14
 th 
april 1983 or CERN data booklet

zeta, see New Scientist 16
th
 august 1984
