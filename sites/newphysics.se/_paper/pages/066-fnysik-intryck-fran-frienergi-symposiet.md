---
title: "Fnysik - Intryck från Frienergi-symposiet"
source_domain: newphysics.se
source_path: archives/fnysik/1_2/symposium/index_se.html
order: 66
...
# Fnysik - Intryck från Frienergi-symposiet

*Source page: `archives/fnysik/1_2/symposium/index_se.html`*
...
Hal Puthoff
    ...
    Så till symposiets huvudnummer - Hal Puthoffs föredrag. Han  började med att diskutera nollpunktsstrålningens roll inom den  moderna fysiken, en strålning som finns även vid absoluta nollpunkten,  då all temperaturstrålning har upphört. Den används  för att förklara bl.a.: 
    
Lamb-shift: att atomspektrumlinjerna har en viss bredd då man  mäter dem i praktiken
