---
title: "INE Devices Database - Commercialization Criteria"
source_domain: padrak.com
source_path: ine/DEVICES_C.html
order: 62
...
*Source page: `ine/DEVICES_C.html`*
...
INE DATABASE LISTING BY COMMERCIALIZATION CRITERIA:
...
Harmonic Frequency Generator Circuit
                Ewing, David & Walt Myers

Patterson Power Cell
                                Patterson, James

CAN BE SCALED LARGER ( 9)

High Voltage Solar Cells
                            Sater, Bernard

Moray Radient Energy Equipment
                      Moray, T. Henry
...
Catalytic Hydrogen Collapse (CHC)
                   Mills, Dr. Randall

Cold Fusion Results
                                 Fox, Hal

Finsrud Motion Machine (Norway)
                     Finsrud, Reidar

Jefimenko Electrostatic Generators
                  Jefimenko, Oleg
...
Pons and Fleischmann Status (France)
                Pons and Fleischmann

RQM Devices (Switzerland)
                           RQM
...
Takahashi Magnet Motor (Japan)
                      Takahashi, Yasunori

Theracore Cold Fusion
                               Thermacore Co.

REPLICATED BY OTHER ( 6) 

Bedini Energy Converter
                             Bedini, John

Podkletnov Device (Finland)
                         Podkletnov, Eugene
...
Brown Resonance Device (US Patent)
                  Brown, Paul
...
Musical Dynasphere (Globe Motor)
                    Pond, Dale; and Keely, John E. W.

Reed Magnetic Motor
                                 Reed, Troy

Rotoverter
                                          Torres, Hector D Perez 
...
Searl Generator (England)
                           Searl, John

Searl Levitation Device (England)
                   Searl, John

Stromerzeuger (Germany)
                             Coler, Hans

Sweet VTA Device
                                    Watson, Don

MORE DATA, 1 PERSON ( 4) 

Gravito Magnetic Device (Canada)
                    Sinclaire, Pierre

Sinclaire Generator (Canada)
                        Sinclaire, Pierre

Venetin Coliu (Austria))
                            Marinov, Stefan

DATA ONCE, 1 PERSON ( 3) 

Angus Engine
                                        Angus, Neil

Bessler's Wheel
                                     Bessler (Orffyreus), J. E. E.

Muller Magnetic Motor
                               Muller, William, J.F.

N-Machine (Trombly-Kahn)
                            Trombly, Adam, Kahn, Joeseph
...
Graham-Low Power Research/Teaching Model
            Graham, Roy
...
APPEARS TO BE UNTRUE ( 1)

Adams Motor (New Zealand)
                           Adams, Robert

Lutec 1000
                                          Lou Brits and John Christie

FOUND TO BE UNTRUE ( 0)  

MORE INFO. IS NEEDED (M) 
...
Switched Reluctance Motor (England)
                 Aspden, Harold
