...
NB
: this page is an appendix to the
...
Fessenden and Marconi: their differing
...
Figure 1: Marconi's antenna system at Poldhu,
                  Cornwall, December 1901.
...
Figure 2: The circuit diagram of the December 1901
                  Poldhu transmitter in J.A. Fleming's handwriting.
...
Marconi clearly realized that to achieve high power from a spark
              ...
              understood (Energy equals 1/2 CV
2
). But he carried the latter requirement
              to an extreme.
...
Figure 3: Clifden, Ireland condenser under
                  construction.
...
Figure 4: The Italian Navy coherer as patented by
                  Marconi in September 1901 (Brit. Pat. 18 105).
...
Figure 5: An early version of Fessenden's receiver
...
The antenna was driven by the curious two stage spark transmitter,
              ...
              the secondary of the antenna transformer T
2
, since in effect the antenna
...
The primary of this transformer consisted of 2 7/20 wires in
              ...
              Garratt made a copy of L
s
 (the secondary of this transformer) and measured
              its inductance to be 6 x 10
-6
 H [see Ratcliffe 1974].


              
While the inductance L
s
...
s
 equal to 6 x 10
-6
 H, we have modelled Marconi's Poldhu
...
A number of scientists and engineers interested in the actual
              ...
              oscillatory circuit by varying the discharge capacitor C
2
 to maximize the
              aerial current. Since our best estimate for the component values (C
2
 =
              0.037 muF and L
p
...
Figure 6: Curve showing the variaton of the
                  ...
                  reocrdings of LF propagation data.
...
Reprinted courtesy of John S.
              Belrose, Communications Research Centre Canada
