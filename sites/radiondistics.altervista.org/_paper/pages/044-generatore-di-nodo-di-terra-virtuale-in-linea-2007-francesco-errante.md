...
Errante
 e' un circuito radio-elettrico basato sullo stesso principio
...
Il V.G.N.G. in-linea pu� generare un nodo di terra virtuale in un
                    ...
                    trasmissione sbilanciata. Questa �, infatti, la sua funzione.
 � anche
                    disponibile la 
versione per linee bilanciate
.
...
1)
 Pu� essere impiegato per stabilizzare
...
2)
 Pu� essere impiegato per fornire un modo affidabile per
...
3)
 Pu� essere usato per stabilizzare le
...
Domanda:
 Utilizzo un'antenna HF con
                          terra virtuale, devo ugualmente impiegare un VGNG in-linea ?

                          
RISPOSTA: NO !
 Il tuo sistema di antenna con terra
...
Domanda:
 In quale punto della mia
                          linea di trasmissione dovrei inserire il VGNG?

                          
RISPOSTA
 Laddove il sistema RTX su linea sbilanciata
...
N.B.
 Se si usa un'adattatore d'impedenza d'antenna, il
...
N.B.
 Il VGNG in-linea deve essere inserito nella linea
