...
This is a brief presentation of 
Francesco
...
, the first physicist and engineer to have
                      ...
                      his own apparatus misterious emissions as "
electric waves
".
                      ...
                      First of all, it is paramount to comprehend that 
the 
hertzian
                      radiation
 is a natural phenomenon with an artificial origin
.
                      Although, the 
hertzian radiation
 mirrors the nuclear reactions
...
. In nature, radiations get generated by
...
hertzian radiation
, instead, the excitation is artificially imposed
                      by means of 
...
Electric oscillation
 is a means to obtain the excitation of the
                      electric charges and it must not be confused with the 
hertzian
                      radiation
 it-self! Unfortunately, this is what has been happening untill
                      now.
...
1) the mere oscillation of electric charges is
                        not the phenomenon at the origin of the 
hertzian radiation
;

                        2) 
hertzian radiation
 can only take place following an energy
...
Simplification
 is the main rule in the observation and understanding
...
, since its birth, has
                      ...
                      however, were ill at birth as the 
open dipole
 is not an aerial as
                      simple as it looks. In addition, having considered the open dipole an
                      "
elementary antenna
" has shifted the focus of those studies away
                      ...
                      prevented from establishing how the 
hertzian radiation
 takes
                      place.
...
Hertz experiment. The apparatus for
                            radio-electric transmission and reception. Birth of the 
hertzian
                            dipole antenna
, 1887.
...
By means of a particular 
radio-electric circuitry for the suppression of anyone of
                      the two branches of a � of wavelength open dipole
, I have demonstrated,
...
elementary
                      antenna
 (by definition an elementary antenna is an aerial where the
                      condition of resonance and radiation cannot take place without the presence
                      of all its parts) but it is, instead, an "
elementary array
" of 2
                      ...
                      research has allowed me to come up with a truly "
elementary radiator
" to further distinguish
                      ...
                      The 
elementary radiator
, infact, comprises a radio-electric
...
detector
 which exploits and, at the meantime,
                      demonstrates the phenomenon of the 
radioluminescence
 from secondary
                      ionization induced by 
hertzian radiation
.
...
Demonstration of the
                            I
st
 Errante's law by radioluminescence.
...
absence of hertzian radiation on conductors
...
: any radio-frequency electric signal or any
                            ...
                            impedance value equal to that of its source, 
will NEVER give
                            origin
...
hertzian radiation takes place whenever charges belonging to a first
                      ...
                      instead.
 (if particles could travel faster then light, their
                      emission would, inevitably, end-up generating shorter wavelength radio
                      signals)


                      
This mechanism is, therefore, a form of 
controlled or limited
                      standing wave regime
, if it happens within the length of the radiator
                      then we have 
resonance
, if it exceeds the length of the radiator we
                      have a 
random standing wave regime
 with less or no
                      radiation
.
...
antiparticle
 is nothing else than an electron flowing back in the opposite direction 
to the one it was initially injected from.


Hence, the minus sign of one of the two 
Dirac's equation
 solutions indicates the negative direction of the particle and not a negative charge of it
!  



Errante
's radio-electric transduction mechanism is fully consistent with 

Prof. John Archibald Wheeler
's own intuition as aknowledged by
...
law of conservation of energy
 holds true, 
while leaves no room for keeping on theorizing about the 
positron
 and the 
antimatter
.
...
As a direct consequence of this findings, when it comes to radio-electric transduction, the concept of 
electromagnetic induction
 does no longer hold true, either. 
Accordingly, the mechanism by which an electrical conductor (ie: radio antenna) gets affected by the 
hertzian radiation
 
must be different from what it was previously thought too and everything points to nothing else than a simple 
photovoltaic effect
, 
just as observed by 
Hertz
 and 
Hallwachs
 in the ultraviolet radiation spectrum.
...
radio-electric transmission
                                  ...
                                  1
st
 from radio-frequency electric
                                  signal to hertzian radiation;

                                  2
nd
 from hertzian radiation back to
...
This particular phenomenon involving an
                            ...
                            radio-frequency radiation and viceversa, is called 
radio-electric
                            transduction
. The 
radio-electric transduction
...
radio-elettric transduction
, are defined as
 
radio-eletctric transducers
