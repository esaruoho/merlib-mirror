...
Balun con terra virtuale per il sistema 
                d'antenna HF multibanda con monopoli ripiegati, da 225 Ohm, in configurazione dipolo
...
NEW! Dipolo multibanda 225+225
                    Ohm
 - Ingresso 50 Ohm sbilanciati uscita 225+225 Ohm bilanciati
...
Dipolo aperto
 a � onda - Ingresso 50 Ohm sbilanciati, uscita
                    70 Ohm bilanciati;
...
Dipolo ripiegato
 a � onda - Ingresso 50 Ohm sbilanciati,
...
Deltaloop
 onda intera a singola spira - Ingresso 50 Ohm
...
Il Balun con terra virtuale, qui presentato, �
                      ...
                      Esso, come il suo omologo il 
circuito
                      radioelettrico per lo sdoppiamento del dipolo ripiegato a � onda
, deriva,
                      infatti, dal 
circuito radioelettrico per la
 ...
 .
                      ...
                      Il balun di 
Errante
 e' essenzialmente un trasformatore elettrico
...
Errante
 puo' essere costruito con pi� di una coppia di
                      secondari.
...
Il balun di 
Errante
 si caratterizza per NON permettere
...
trasformatore di 
Guanella
 od il trasformatore di
                      
Ruthroff
 che invece sono caratterizzati dall'avere un rapporto
                      ...
                      Quindi, supponendo di disporre di un balun del tipo 
Guanella
 con
                      ...
                      di 200 Ohm e cosi' via. 
Questo non puo' invece avvenire con l'impiego di un balun
                      del tipo 
Errante
, perche' i valori d'impedenza di ognuna delle sue
...
Questo e' un particolare da non sottovalutare, non solo in fase di trasmissione 
                      ...
                      d'antenna che impiegano i balun di 
Errante
                      ...
                      aperti o ripiegati (ivi incluse le antenne del tipo 
deltaloop
);
...
Radiondistics
, parimenti, rivendica l'originalita' delle soluzioni
