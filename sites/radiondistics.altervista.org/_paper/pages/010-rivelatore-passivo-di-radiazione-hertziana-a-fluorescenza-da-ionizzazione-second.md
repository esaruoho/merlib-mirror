...
radio-electric circuitry
 for the suppression of
                      ...
                      without the necessity of the presence of its symmetric (see 
Hertzian
                      Dipole
 ) or the necessity of a natural ground plane (see 
Marconi's
                      Antenna
 ) or an artificial one made of radials or counterpoises as in
                      the 
Ground Plane Antenna
. The need to have the Earth or another
                      ...
                      wavelength, has been eliminated by generating a 
virtual ground node
,
...
The solution to that problem is
                      given by the possibility of generating the 
virtual ground node
 by
                      recombining two radio-electric signals, identical but 180 degree out of phase
                      between them-selves.
 This can be achieved by employing a broad-band
                      ...
                      said 
virtual ground node
 to be used as a zero-potential reference
                      ...
                      the 
VIRTUAL GROUND � of wavelength MONOPOLE ANTENNA
, they alone,
                      ...
                      accomplished by the 
twinned coaxial transmission
                      lines
(7) which can be of any length but must be identical between
...
studies on the behaviour of a balanced
                      transmission line in a progressive wave regime
, a
...
most 
F.A.Q.
: can I drive 2 or more
                            monopoles simultaneously, as in a 
fan dipole
 configuration, so
...
ANSWER: Yes !
   The present virtual ground RF feeding
