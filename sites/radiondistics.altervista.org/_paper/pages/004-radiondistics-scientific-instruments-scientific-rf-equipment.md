...
Radiondistics' scientific equipment
...
Errante's apparatus for the
                        physics of the balanced transmission lines for radio frequency electric
                        signals.
...
Errante's balanced line virtual
                        ground node generator
...
Errante's all-in-one
                        original apparatus
 to carry out measurements and experiments on the
                        open and folded dipole antennas and on the physics of the hertzian
                        radiation.
...
A virtual ground balun
 for
                        the suppression of any which one of the two branches of an � wavelength
                        open dipole antenna. 
PATENT n.0001347484
...
balun with built
                        in S.W.R. meters
. It is designed around our 
Suppressor
 circuitry and has 3 built in
                        S.W.R. meters, one for each of its ports.
...
elementary radiator
, a virtual ground
                        monopole HF antenna, also known as the 
Errante's Antenna
.
...
A secondary ionization fluorescence hertzian radiation
                        passive 
detector
. 
PATENT
