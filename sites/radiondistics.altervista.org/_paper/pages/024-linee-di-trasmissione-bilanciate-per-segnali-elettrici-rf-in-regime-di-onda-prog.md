...
Planning a trip to Sicily? ï¿½Then,
...
Premessa: sebbene
                            ...
                            identici e paralleli tra di loro, comunemente dette "
linee
                            bifilari
", bisogna tenere presente che le linee di trasmissione
                            ...
                            (L'arrangiamento di correnti poli-fase ï¿½ stato introdotto in elettrotecnica da 
Nikola Tesla
)
...
una linea di trasmissione
                            per segnali elettrici ï¿½ elettricamente bilanciata quando la stessa non
...
: ï¿½ "
una
                            linea di trasmissione per segnali elettrici elettricamente bilanciata ï¿½
                            simmetrica quando ï¿½ formata da conduttori elettrici che esibiscono lo
...
una
                            linea di trasmissione per segnali elettrici elettricamente bilanciata ï¿½
                            a-simmetrica quando ï¿½ formata da conduttori elettrici che NON
...
Errante
 per le linee di trasmissione
: ï¿½ "
una linea di
                            trasmissione per segnali radioelettrici, sia essa bilanciata o
                            sbilanciata, se in regime di onda progressiva, ï¿½ sempre
                            a-periodica
."
...
: "
una qualsiasi
                            linea di trasmissione per segnali radioelettrici puï¿½ essere convertita
...
In ogni punto
                            ...
                            essa bilanciata che sbilanciata, ï¿½ sempre possibile generare un nodo di
                            terra virtuale
."
...
Errante
 applicata alle linee di trasmissione
 "
una
...
L'apparato ed il metodo di misura qui presentati
                ...
                c) dimostrare che ï¿½ sempre possibile generare un nodo di terra virtuale in ogni
                ...
                sia alla sorgente RF che al carico, NON originano radiazione hertziana. 
II
a
 legge di
                Errante
...
L
e linee di trasmissione bilanciate per
...
Una linea di trasmissione per segnali elettrici ï¿½
                elettricamente bilanciata quando la stessa non interviene a modificare lo
                sfasamento delle correnti che la attraversano.

                perchï¿½ ciï¿½ sia possibile e' necessario che tutti i conduttori che costituiscono la
                linea siano identici e che la linea stessa sia perfettamente adattata sia al suo
                ingresso che alla sua uscita, ciï¿½ vuol dire che l'impedenza caratteristica della
                ...
                Una linea di trasmissione correttamente adattata, quando ï¿½ in esercizio, si trova
                in 
regime di onda progressiva
 e si ha il massimo trasferimento
                energetico possibile al carico ed assenza di 
radiazione hertziana
.

                

                Laddove la linea viaggi in stretta prossimitï¿½ della terra fisica, ï¿½ anche
                ...
                A paritï¿½ di distanza interassiale tra i conduttori della linea, la sua impedenza
                caratteristica diminuisce col diminuire della distanza dalla terra fisica. Ciï¿½ ï¿½
                dovuto all'accoppiamento capacitivo tra i conduttori della linea e la terra fisica
                che si somma alla capacitï¿½ elettrica parassita, sempre presente tra i conduttori
                della linea stessa.
                ...
                della linea e la terra rende trascurabile le capacitï¿½ parassite tra i conduttori
                della linea stessa e non necessiterï¿½ piï¿½ che questi ultimi viaggino paralleli, ma
                devono comunque essere identici, eccetto quando formino una 
linea bilanciata
                a-simmetrica
.
...
Una linea bilanciata a-simmetrica ï¿½ cosï¿½ definita: "
una linea di
                trasmissione per segnali elettrici elettricamente bilanciata ï¿½ a-simmetrica quando
                la stessa non interviene a modificare lo sfasamento delle correnti che la
                attraversano ed ï¿½ formata da conduttori elettrici che non esibiscono lo stesso
                valore di impedenza rispetto alla terra od al nodo di terra virtuale. Copyright
                2008 Francesco Errante
".

                Lo stretto accoppiamento con la terra limita, perï¿½, l'impiego di linee rasoterra ai
                ...
                dagli albori della radiotecnica ï¿½ dato dal loro impiego per l'alimentazione delle
                antenne a dipolo ripiegato a mezz'onda. Ciï¿½ perchï¿½ alle utili proprietï¿½ del dipolo
                ripiegato a mezz'onda si unisce la facilitï¿½ di realizzazione delle linee bilanciate
                a 300 Ohm. 
(come analogamente avviene per i dipoli a mezz'onda a piï¿½ archi
                ...
                facilitï¿½ con la quale ï¿½ possibile alimentare un dipolo ripiegato a mezz'onda con un
                ...
                Al dilagare di queste ï¿½credenzeï¿½ ha contribuito anche lï¿½errata interpretazione da
                parte di molti dellï¿½esperimento di 
Ernst Lecher
. La linea di Lecher,
                infatti, evidenzia il comportamento elettrico di una linea bifilare in regime di
                onda stazionaria ed il suo impiego come ondametro ï¿½ vano se la linea ï¿½ invece in
                regime di onda progressiva (VSWR = 1:1) .

                

                L'illusione strumentale che le linee bilanciate siano risonanti ï¿½ data dal fatto
                ...
                ciclicitï¿½ il punto di risonanza risultante del sistema stesso.

                

                
In veritï¿½, se in un sistema costituito da fonte di segnale bilanciato,
...
Qui appresso e' riportata la sequenza logica delle misure ed i
                ...
                Il secondo modo e' di gran lunga il piï¿½ conveniente e veloce, quindi 
si ï¿½
                utilizzata una linea bilanciata a 300 Ohm di lunghezza fisica fissa e si ï¿½
...
.
                ...
                ciï¿½ perche le stesse permettono, tra l' altro, una maggiore escursione di lunghezza
                d'onda a paritï¿½ di variazione di frequenza. 
Tutti i risultati delle misure
                ...
                linee, mentre garantiscono sempre una totale continuitï¿½ galvanica tra tutti i
                circuiti ad essi collegati, assicurando un solido percorso di terra comune che puï¿½
                essere, all'occorrenza, collegato alle terra fisica. Vedi anche: 
generatore di terra virtuale per linee sbilanciate
...
OPERAZIONE PRELIMINARE: il sistema di misura
                    bilanciato-bilanciato viene sottoposto a verifica iniziale della linearitï¿½
...
Frequenze di prova: da 1,8 a 30 MHz a passi da 100 KHz
                    ...
                    R.O.S. misurato: ï¿½ 1:1 ï¿½ su tutto lo spettro
...
Frequenze di prova: da 1,8 a 30 MHz a passi da 100 KHz
                    ...
                    Esito: l'aperiodicitï¿½ della linea ï¿½ verificata.
...
Lo stesso avviene se la linea ï¿½ terminata su un carico
                    reattivo (BalUn di Errante) ed il segnale sbilanciato cosï¿½ ottenuto viene
...
E cosï¿½ pure avviene se la linea ï¿½ disaccoppiata dal carico
                    anti-induttivo mediante un generatore di nodo di terra virtuale per linee
                    bilanciate, di pari impedenza (
BVGNG di Errante
).
...
circuito radioelettrico per la generazione
                    del nodo di terra per sistemi bilanciati
, ï¿½ stato possibile
...
Linea bilanciata a 300 Ohm, alimentata da fonte
                    bilanciata a 300 Ohm, terminata su dipolo bilanciato attraverso un 
BVGNG di
                    Errante
 da 300/300 Ohm e sottoposta a misura
                    rosmetrica
...
a
 misura
                    ...
                    Frequenze di prova: 
centro della gamma di lavoro del dipolo ripiegato -
                    MHz 22,9

                    Potenza RF impiegata: 1 KW cw

                    R.O.S. misurato: ï¿½ 1:1 ï¿½ @ MHz 22,9
...
a
 misura
                    ...
                    Frequenze di prova: 
NUOVO centro della gamma di lavoro del dipolo
                    ripiegato - MHz 23,5

                    Potenza RF impiegata: 1 KW cw

                    R.O.S. misurato: ï¿½ 1:1 ï¿½ @ MHz 23,5
...
Esito:
                    ...
                    2) l'aperiodicitï¿½ della linea ï¿½ verificata.
...
Si e' sottoposta una linea di trasmissione
                    ...
                    RF) a rilevazione della radiazione hertziana col metodo della 
radioluminescenza
.

                    Si ï¿½, cosï¿½, osservato e dimostrato che non vi ï¿½ insorgenza di radiazione
...
Si ï¿½ deliberatamente imposto un regime di onda
                    ...
                    Si ï¿½, cosï¿½, ossevata e dimostrata l'insorgenza di radiazione hertziana su linea
...
Per conoscere i distributori dei
              ns. prodotti scientifici, fai click
...
.
               ...
               Questo materiale ï¿½ protetto dalle leggi sul 
Diritto d'Autore
 e sulla
              proprietï¿½ intellettuale.
              ...
              informatico, telematico, fotografico o meccanico ï¿½ consentito esclusivamente per uso personale.
