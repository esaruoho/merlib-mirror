...
" , it must be said that
                            ...
                            arrangement. 
                            (Poly-phase currents arrangement were first introduced in the electrical engineering by 
Nikola Tesla
)
...
Errante
's
                            principle for the transmission lines
: � "
a transmission line
...
Errante
's
                            law applied to the transmission lines
 "
a transmission line for
...
T
he balanced transmission lines for radio
...
An example of an electrically balanced line employing a
              pair of individually shielded coaxial cables(7) - Copyright © 1985-
 Francesco Errante
...
A transmission line for electric signals is electrically
                ...
                transmission line, when being runned, is in a 
progressive wave
                regime
 and the energy transfer to the load is maximum with no 
hertzian
                radiation
 being originated.
                ...
                to each other, unless they are ment to form an 
asymmetric balanced
                line
.
...
An asymmetric balanced line is so defined: "
...
half a wave length folded dipole
 antenna. This because, a 300 Ohm balanced
                transmission line adds ease of construction to the folded dipole's useful
                properties. 
(The same can be said for the multiple-wire folded dipoles that
                ...
                shortening them. This desumption is false! 
Ernst Lecher
's experiment
...
A step-by-step sequence of all the measurements taken, along with
                ...
                that, 
a 300 Ohm balanced line of a fixed physical length has been used and
...
.
                ...
                excursion for the same frequency span. 
All the measurements results,
                ...
                necessary, connected to the physical ground. See also: 
A virtual
...
Finally
, by employing a 
virtual ground node generator for electrically balanced
                    systems
, it has been dimostrated that balanced lines, if properly decoupled
...
st
 test:
                    ...
                    Test frequency: 
test dipole center frequency - MHz 22,9
...
nd
 test:
                    ...
                    Test frequency: 
NEW test dipole center frequency - MHz
                    23,5
...
rd
 test:
                    ...
                    Test frequency: 
test dipole center frequency found to be back on MHz
                    22,9
...
A properly adapted 300 Ohm balanced transmission
                    line terminated on a 1/2 wavelenght folded dipole, through a 
balanced virtual ground node
                    generator
 , undergoing a radioscopic detection.
