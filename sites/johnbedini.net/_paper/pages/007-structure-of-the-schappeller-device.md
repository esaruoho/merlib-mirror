---
title: "Structure of the Schappeller Device"
source_domain: johnbedini.net
source_path: john34/Radiant.htm
order: 7
...
*Source page: `john34/Radiant.htm`*

Structure of the Schappeller Device 

      
First developed in Germany. 
After the Second World War two different sciences developed called "Physics". One was the relativism taught in schools. The second more esoteric type wasutilized only secretly, by the secret government, for deep blackprojects. 
...
Stated another way, this is an implosion device and it is described as such . Unlike the Schauberger device which is associated with the word implosion, the Schappeller device operates purely at the energetic level. 
Energy is drawn towards the center, through the magnets, into the field of glowing magnetism, and then radiated outward.
 

      
The first explanation for this output of radiant energy involves the concept of the 
Bloch Wall.
 A Bloch Wall is defined by Van Norstrand's Scientific Encyclopedia, 1958 edition, pages 201 and 202, as follows: 
...
In electromagnetics the Bloch Wall is external to the hardware itself.
 It is the point of division of the circling vortex, or spin, of the electronic magnetic energies of the north and south poles. 
The negative north pole magnetism spins to the left while the positive south pole spins to the right. Energy is being conducted into the Schappeller device through the un-insulated poles and being conducted and spun on its way to the center of the unit. The point of zero magnetism, no spin and magnetic reversal, where the two spin fields join, is the Bloch Wall . 
